...
var GLmol = (function () {
	...
	GLmol.prototype.loadSDF = function (str) {
		this.loadMolecule(str, this.parseSDF);
	};
	GLmol.prototype.loadXYZ = function (str) {
		this.loadMolecule(str, this.parseXYZ);
	};
	GLmol.prototype.loadPDB = function (str) {
		this.loadMolecule(str, this.parsePDB);
	};
