(function (a, m) {
    ...
    function l(f) {
        var v = f.length,
            a = g.type(f);
        return "function" === a || g.isWindow(f) ? !1 : 1 === f.nodeType && v ? !0 : "array" === a || 0 === v || "number" === typeof v && 0 < v && v - 1 in f
    }

    function h(f, v, a) {
        if (g.isFunction(v)) return g.grep(f, function (f, g) {
            return !!v.call(f,
                g, f) !== a
        });
        if (v.nodeType) return g.grep(f, function (f) {
            return f === v !== a
        });
        if ("string" === typeof v) {
            if (Vc.test(v)) return g.filter(v, f, a);
            v = g.filter(v, f)
        }
        return g.grep(f, function (f) {
            return 0 <= g.inArray(f, v) !== a
        })
    }

    function e(f, v) {
        do f = f[v]; while (f && 1 !== f.nodeType);
        return f
    }
    ...
    function t() {
        if (y.addEventListener || "load" === event.type ||
            "complete" === y.readyState) j(), g.ready()
    }

    function s(f, v, a) {
        if (void 0 === a && 1 === f.nodeType)
            if (a = "data-" + v.replace(Wc, "-$1").toLowerCase(), a = f.getAttribute(a), "string" === typeof a) {
                try {
                    a = "true" === a ? !0 : "false" === a ? !1 : "null" === a ? null : +a + "" === a ? +a : Xc.test(a) ? g.parseJSON(a) : a
                } catch (I) {}
                g.data(f, v, a)
            } else a = void 0;
        return a
    ...
    function u(f) {
        for (var a in f)
            if (!("data" === a && g.isEmptyObject(f[a])) && "toJSON" !== a) return !1;
        return !0
    }
    ...
    function b(f, a, p, I) {
        if (g.acceptData(f)) {
            var b = g.expando,
                ...
                n =
                c ? f[b] : f[b] && b;
            if (n && d[n] && (I || d[n].data) || !(void 0 === p && "string" === typeof a)) {
                n || (n = c ? f[b] = k.pop() || g.guid++ : b);
                d[n] || (d[n] = c ? {} : {
                    toJSON: g.noop
                });
                if ("object" === typeof a || "function" === typeof a) I ? d[n] = g.extend(d[n], a) : d[n].data = g.extend(d[n].data, a);
                f = d[n];
                I || (f.data || (f.data = {}), f = f.data);
                void 0 !== p && (f[g.camelCase(a)] = p);
                "string" === typeof a ? (p = f[a], null == p && (p = f[g.camelCase(a)])) : p = f;
                return p
            }
        }
    }
    ...
    function c(f, a, p) {
        if (g.acceptData(f)) {
            var I, b, c = f.nodeType,
                k = c ? g.cache : f,
                d = c ? f[g.expando] : g.expando;
            if (k[d]) {
                if (a &&
                    (I = p ? k[d] : k[d].data)) {
                    g.isArray(a) ? a = a.concat(g.map(a, g.camelCase)) : a in I ? a = [a] : (a = g.camelCase(a), a = a in I ? [a] : a.split(" "));
                    for (b = a.length; b--;) delete I[a[b]];
                    if (p ? !u(I) : !g.isEmptyObject(I)) return
                }
                if (!p && (delete k[d].data, !u(k[d]))) return;
                c ? g.cleanData([f], !0) : w.deleteExpando || k != k.window ? delete k[d] : k[d] = null
            }
        }
    }
    ...
    function B(f) {
        ...
        if (f.createElement)
            for (; a.length;) f.createElement(a.pop());
        return f
    }

    function E(f, a) {
        var p, I, b = 0,
            c = typeof f.getElementsByTagName !== la ? f.getElementsByTagName(a || "*") : typeof f.querySelectorAll !== la ? f.querySelectorAll(a || "*") : void 0;
        if (!c) {
            c = [];
            for (p = f.childNodes || f; null != (I = p[b]); b++) !a || g.nodeName(I, a) ? c.push(I) : g.merge(c, E(I, a))
        }
        return void 0 === a || a && g.nodeName(f, a) ? g.merge([f], c) : c
    }

    function rb(f) {
        Mb.test(f.type) && (f.defaultChecked = f.checked)
    }

    function Ya(f, a) {
        return g.nodeName(f, "table") && g.nodeName(11 !== a.nodeType ? a : a.firstChild, "tr") ? f.getElementsByTagName("tbody")[0] ||
            f.appendChild(f.ownerDocument.createElement("tbody")) : f
    }

    function Ea(f) {
        f.type = (null !== g.find.attr(f, "type")) + "/" + f.type;
        return f
    }

    function U(f) {
        var a = Yc.exec(f.type);
        a ? f.type = a[1] : f.removeAttribute("type");
        return f
    }

    function Q(f, a) {
        for (var p, I = 0; null != (p = f[I]); I++) g._data(p, "globalEval", !a || g._data(a[I], "globalEval"))
    }

    function Fa(f, a) {
        if (1 === a.nodeType && g.hasData(f)) {
            var p, I, b;
            I = g._data(f);
            var c = g._data(a, I),
                k = I.events;
            if (k)
                for (p in delete c.handle, c.events = {}, k) {
                    I = 0;
                    for (b = k[p].length; I < b; I++) g.event.add(a,
                        p, k[p][I])
                }
    ...
    function Pa(f, v) {
        var p = g(v.createElement(f)).appendTo(v.body),
            I = a.getDefaultComputedStyle ? a.getDefaultComputedStyle(p[0]).display : g.css(p[0], "display");
        p.detach();
        return I
    }
    ...
    function db(f) {
        ...
        if (!p) {
            p = Pa(f, a);
            if ("none" === p || !p) eb = (eb || g("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement), a = (eb[0].contentWindow || eb[0].contentDocument).document, a.write(), a.close(), p = Pa(f, a), eb.detach();
            nc[f] = p
        }
        return p
    }
    ...
    function gb(f, a) {
        if (a in f) return a;
        for (var p = a.charAt(0).toUpperCase() + a.slice(1), I = a, b = oc.length; b--;)
            if (a = oc[b] + p, a in f) return a;
        return I
    }

    function va(f, a) {
        for (var p, b, c, k = [], d = 0, n = f.length; d < n; d++)
            if (b = f[d], b.style)
                if (k[d] = g._data(b, "olddisplay"), p = b.style.display, a) !k[d] && "none" === p && (b.style.display = ""), "" === b.style.display && hb(b) && (k[d] = g._data(b, "olddisplay", db(b.nodeName)));
                else if (!k[d] && (c = hb(b), p && "none" !== p || !c)) g._data(b, "olddisplay", c ? p : g.css(b, "display"));
        for (d = 0; d < n; d++)
            if (b = f[d], b.style && (!a || "none" === b.style.display || "" === b.style.display)) b.style.display = a ? k[d] || "" : "none";
        return f
    }

    function ma(f, a, p) {
        return (f = Zc.exec(a)) ? Math.max(0, f[1] - (p || 0)) + (f[2] || "px") : a
    }

    function x(f, a, p, b, c) {
        a = p === (b ? "border" : "content") ? 4 : "width" === a ? 1 : 0;
        for (var k = 0; 4 > a; a += 2) "margin" === p && (k += g.css(f, p + Qa[a], !0, c)), b ? ("content" === p && (k -= g.css(f, "padding" + Qa[a], !0, c)), "margin" !== p && (k -=
            g.css(f, "border" + Qa[a] + "Width", !0, c))) : (k += g.css(f, "padding" + Qa[a], !0, c), "padding" !== p && (k += g.css(f, "border" + Qa[a] + "Width", !0, c)));
        return k
    }

    function aa(f, a, p) {
        var b = !0,
            c = "width" === a ? f.offsetWidth : f.offsetHeight,
            k = Ra(f),
            d = w.boxSizing() && "border-box" === g.css(f, "boxSizing", !1, k);
        if (0 >= c || null == c) {
            c = Sa(f, a, k);
            if (0 > c || null == c) c = f.style[a];
            if (sb.test(c)) return c;
            b = d && (w.boxSizingReliable() || c === f.style[a]);
            c = parseFloat(c) || 0
        }
        return c + x(f, a, p || (d ? "border" : "content"), b, k) + "px"
    }

    function L(f, a, p, b, g) {
        return new L.prototype.init(f,
            a, p, b, g)
    }
    ...
    function O(f, a) {
        var p, b = {
            ...
            g = 0;
        for (a = a ? 1 : 0; 4 > g; g += 2 - a) p = Qa[g], b["margin" + p] = b["padding" + p] = f;
        a && (b.opacity = b.width = f);
        return b
    }

    function wa(f, a, p) {
        for (var b, g = (ib[a] || []).concat(ib["*"]), c = 0, k = g.length; c < k; c++)
            if (b = g[c].call(p, a, f)) return b
    }
    ...
    function jb(f, a, p) {
        var b, c, k = 0,
            ...
            r = n.promise({
                ...
                createTween: function (a, v) {
                    var p = g.Tween(f, r.opts, a, v, r.opts.specialEasing[a] || r.opts.easing);
                    r.tweens.push(p);
                    return p
                },
                stop: function (a) {
                    ...
                    a ? n.resolveWith(f, [r, a]) : n.rejectWith(f, [r, a]);
                    return this
                }
            });
        a = r.props;
        ...
        var q, h, l, j;
        for (b in a)
            if (q = g.camelCase(b), h = p[q], l = a[b], g.isArray(l) && (h = l[1], l = a[b] = l[0]), b !== q && (a[q] = l, delete a[b]), (j = g.cssHooks[q]) && "expand" in j)
                for (b in l = j.expand(l), delete a[q], l) b in a || (a[b] = l[b], p[b] = h);
            else p[q] = h;
        for (; k < d; k++)
            if (b = tb[k].call(r, f, a, r.opts)) return b;
        g.map(a, wa, r);
        g.isFunction(r.opts.start) && r.opts.start.call(f, r);
        g.fx.timer(g.extend(e, {
            elem: f,
            anim: r,
            queue: r.opts.queue
        }));
    ...
    function kb(f) {
        return function (a, p) {
            ...
            if (g.isFunction(p))
                for (; b = k[c++];) "+" === b.charAt(0) ? (b = b.slice(1) || "*", (f[b] = f[b] || []).unshift(p)) : (f[b] = f[b] || []).push(p)
        }
    }
    ...
    function ya(f, a) {
        var p, b, c = g.ajaxSettings.flatOptions || {};
        for (b in a) void 0 !== a[b] && ((c[b] ? f : p || (p = {}))[b] = a[b]);
        p && g.extend(!0, f, p);
        return f
    }
    ...
    function na(f, a, p, b) {
        var c;
        if (g.isArray(a)) g.each(a, function (a, v) {
            p || ad.test(f) ? b(f, v) : na(f + "[" + ("object" === typeof v ? a : "") + "]", v, p, b)
        });
        else if (!p && "object" === g.type(a))
            for (c in a) na(f + "[" + c + "]", a[c], p, b);
        else b(f, a)
    }

    function C(f) {
        try {
            return f ? new a.ActiveXObject("Microsoft.XMLHTTP") :
    ...
    function V(f) {
        return g.isWindow(f) ? f : 9 === f.nodeType ? f.defaultView || f.parentWindow : !1
    }
    var k = [],
        n = k.slice,
        r = k.concat,
    ...
    g.fn = g.prototype = {
        ...
        get: function (f) {
            return null != f ? 0 > f ? this[f + this.length] : this[f] : n.call(this)
        },
        pushStack: function (f) {
            f = g.merge(this.constructor(), f);
            f.prevObject = this;
            f.context = this.context;
            return f
        },
        each: function (f, a) {
            return g.each(this, f, a)
        },
        map: function (f) {
            return this.pushStack(g.map(this, function (a, p) {
                return f.call(a, p, a)
            }))
        },
        slice: function () {
        ...
        eq: function (f) {
            var a =
                this.length;
            f = +f + (0 > f ? a : 0);
            return this.pushStack(0 <= f && f < a ? [this[f]] : [])
        },
        end: function () {
    ...
    g.extend = g.fn.extend = function () {
        ...
        for (; d < n; d++)
            if (null != (c = arguments[d]))
                for (b in c) f = k[b], p = c[b], k !== p && (e && p && (g.isPlainObject(p) || (a = g.isArray(p))) ? (a ?
                    (a = !1, f = f && g.isArray(f) ? f : []) : f = f && g.isPlainObject(f) ? f : {}, k[b] = g.extend(e, f, p)) : void 0 !== p && (k[b] = p));
        return k
    };
    g.extend({
        ...
        isPlainObject: function (f) {
            var a;
            if (!f || "object" !== g.type(f) || f.nodeType || g.isWindow(f)) return !1;
            try {
                if (f.constructor && !za.call(f, "constructor") && !za.call(f.constructor.prototype, "isPrototypeOf")) return !1
            } catch (p) {
                return !1
            }
            if (w.ownLast)
                for (a in f) return za.call(f, a);
            for (a in f);
            return void 0 === a || za.call(f, a)
        },
        type: function (f) {
            return null == f ? f + "" : "object" === typeof f || "function" === typeof f ? P[bd.call(f)] || "object" : typeof f
        },
        globalEval: function (f) {
            f && g.trim(f) && (a.execScript || function (f) {
                a.eval.call(a,
                    f)
            })(f)
        },
        camelCase: function (f) {
            return f.replace(dd, "ms-").replace(ed, fd)
        },
        nodeName: function (f, a) {
        ...
        each: function (f, a, p) {
            ...
            if (p)
                if (b)
                    for (; g < c && !(b = a.apply(f[g], p), !1 === b); g++);
                else
                    for (g in f) {
                        if (b = a.apply(f[g], p), !1 === b) break
                    } else if (b)
                        for (; g < c && !(b = a.call(f[g], g, f[g]), !1 === b); g++);
                    else
                        for (g in f)
                            if (b = a.call(f[g], g, f[g]), !1 === b) break;
            return f
        },
        trim: Ob && !Ob.call("\ufeff\u00a0") ? function (f) {
            return null == f ? "" : Ob.call(f)
        } : function (f) {
            return null == f ? "" : (f + "").replace(cd, "")
        },
        makeArray: function (f, a) {
            var p = a || [];
            null != f && (l(Object(f)) ? g.merge(p, "string" === typeof f ? [f] : f) : z.call(p, f));
            return p
        },
        inArray: function (f, a, p) {
            var b;
            if (a) {
                if (F) return F.call(a, f, p);
                b = a.length;
                for (p = p ? 0 > p ? Math.max(0, b + p) : p : 0; p < b; p++)
                    if (p in a && a[p] === f) return p
            }
            return -1
        },
        merge: function (f, a) {
            for (var p = +a.length, b = 0, g = f.length; b < p;) f[g++] = a[b++];
            if (p !== p)
                for (; void 0 !== a[b];) f[g++] = a[b++];
            f.length = g;
            return f
        },
        grep: function (f, a, p) {
            for (var b = [], g = 0, c =
                    f.length, k = !p; g < c; g++) p = !a(f[g], g), p !== k && b.push(f[g]);
            return b
        },
        map: function (f, a, p) {
            var b, g = 0,
                ...
                k = [];
            if (l(f))
                for (; g < c; g++) b = a(f[g], g, p), null != b && k.push(b);
            else
                for (g in f) b = a(f[g], g, p), null != b && k.push(b);
            return r.apply([], k)
        },
        guid: 1,
        proxy: function (f, a) {
            var p, b;
            "string" === typeof a && (b = f[a], a = f, f = b);
            if (g.isFunction(f)) return p = n.call(arguments, 2), b = function () {
                return f.apply(a || this, p.concat(n.call(arguments)))
            }, b.guid = f.guid = f.guid || g.guid++, b
        },
        now: function () {
            return +new Date
        },
    ...
    g.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function (f, a) {
    ...
    var Pb = a,
        D = function (f, a, p, b) {
            ...
            if (X && !b) {
                if (g = gd.exec(f))
                    ...
                    if (g[2]) return Ga.apply(p, a.getElementsByTagName(f)), p;
                    if ((k = g[3]) && H.getElementsByClassName && a.getElementsByClassName) return Ga.apply(p, a.getElementsByClassName(k)), p
                }
                if (H.qsa && (!S || !S.test(f))) {
                    c = g = M;
                    k = a;
                    ...
                    if (1 === d && "object" !== a.nodeName.toLowerCase()) {
                        d = ta(f);
                        (g = a.getAttribute("id")) ? c = g.replace(hd, "\\$&"): a.setAttribute("id", c);
                        c = "[id='" + c + "'] ";
                        for (k = d.length; k--;) d[k] = c + vb(d[k]);
                        k = Qb.test(f) && ha(a.parentNode) || a;
                        n = d.join(",")
                    }
                    if (n) try {
                        return Ga.apply(p,
                        ...
                        g || a.removeAttribute("id")
                    }
                }
            }
            var r;
            a: {
                f = f.replace(wb, "$1");c = ta(f);
                if (!b && 1 === c.length) {
                    g = c[0] = c[0].slice(0);
                    if (2 < g.length && "ID" === (r = g[0]).type && H.getById && 9 === a.nodeType && X && G.relative[g[1].type]) {
                        a = (G.find.ID(r.matches[0].replace(Ha, Ia), a) || [])[0];
                        if (!a) {
                            r = p;
                            break a
                        }
                        f = f.slice(g.shift().value.length)
                    }
                    for (d = xb.needsContext.test(f) ? 0 : g.length; d--;) {
                        r = g[d];
                        if (G.relative[k = r.type]) break;
                        if (k = G.find[k])
                            if (b = k(r.matches[0].replace(Ha, Ia), Qb.test(g[0].type) &&
                                    ha(a.parentNode) || a)) {
                                g.splice(d, 1);
                                f = b.length && vb(g);
                                if (!f) {
                ...
                $a(f, c)(b, a, !X, p, Qb.test(f) && ha(a.parentNode) || a);r = p
            }
            return r
        },
        Rb = function () {
            function f(p, b) {
                a.push(p + " ") > G.cacheLength && delete f[a.shift()];
                return f[p + " "] = b
            }
            var a = [];
            return f
        ...
        Sb = function (f, a) {
            for (var p = f.split("|"), b = f.length; b--;) G.attrHandle[p[b]] =
                a
        },
        pc = function (f, a) {
            var p = a && f,
                b = p && 1 === f.nodeType && 1 === a.nodeType && (~a.sourceIndex || ia) - (~f.sourceIndex || ia);
            if (b) return b;
            if (p)
                for (; p = p.nextSibling;)
                    if (p === a) return -1;
        ...
        id = function (f) {
            return function (a) {
                return "input" === a.nodeName.toLowerCase() && a.type === f
            }
        },
        jd = function (f) {
            return function (a) {
                var p = a.nodeName.toLowerCase();
                return ("input" === p || "button" === p) && a.type === f
            }
        },
        ua = function (f) {
            return pa(function (a) {
                ...
                return pa(function (p, b) {
                    for (var g, c = f([], p.length, a), k = c.length; k--;)
                        if (p[g =
                                c[k]]) p[g] = !(b[g] = p[g])
                })
            })
        ...
        ha = function (f) {
            return f && typeof f.getElementsByTagName !== T && f
        },
        qc = function () {},
        ta = function (f, a) {
            var p, b, g, c, k, d, n;
            if (k = Ja[f + " "]) return a ? 0 : k.slice(0);
            k = f;
            d = [];
            for (n = G.preFilter; k;) {
                if (!p || (b = kd.exec(k))) b && (k = k.slice(b[0].length) || k), d.push(g = []);
                p = !1;
                if (b = ld.exec(k)) p = b.shift(), g.push({
                    value: p,
                    type: b[0].replace(wb, " ")
                }), k = k.slice(p.length);
                for (c in G.filter)
                    if ((b = xb[c].exec(k)) && (!n[c] || (b = n[c](b)))) p = b.shift(), g.push({
                        value: p,
                        type: c,
                        matches: b
                    }), k = k.slice(p.length);
            ...
            return a ? k.length : k ? D.error(f) : Ja(f, d).slice(0)
        },
        vb = function (f) {
            for (var a = 0, p = f.length, b = ""; a < p; a++) b += f[a].value;
            return b
        },
        Tb = function (f, a, p) {
            var b = a.dir,
            ...
            return a.first ? function (a, p, v) {
                for (; a = a[b];)
                    if (1 === a.nodeType || g) return f(a, p, v)
            } : function (a, p, v) {
                var k, d, n = [ca, c];
                if (v)
                    for (; a = a[b];) {
                        if ((1 === a.nodeType || g) && f(a, p, v)) return !0
                    } else
                        for (; a = a[b];)
                            if (1 === a.nodeType || g) {
                                d = a[M] || (a[M] = {});
        ...
        Ub = function (f) {
            return 1 < f.length ? function (a, p, b) {
                for (var g = f.length; g--;)
                    if (!f[g](a, p, b)) return !1;
                return !0
            } : f[0]
        },
        Ta = function (f, a, p, b, g) {
            for (var c, k = [], d = 0, n = f.length, e = null != a; d < n; d++)
                if (c = f[d])
                    if (!p || p(c, b, g)) k.push(c), e && a.push(d);
            return k
        },
        Vb = function (f, a, p, b, g, c) {
            b && !b[M] && (b = Vb(b));
            g && !g[M] && (g = Vb(g, c));
            return pa(function (c, k, d, n) {
                ...
                if (!(h = c)) {
                    h = a || "*";
                    for (var j = d.nodeType ? [d] : d, A = [], z = 0, T = j.length; z < T; z++) D(h, j[z], A);
                    h = A
                }
                h = f && (c || !a) ? Ta(h, fa, f, d,
                    n) : h;
                ...
                if (c) {
                    if (g || f) {
                        if (g) {
                            e = [];
                            for (d = j.length; d--;)
                                if (r = j[d]) e.push(h[d] = r);
                            g(null, j = [], e, n)
                        }
                        for (d = j.length; d--;)
                            if ((r = j[d]) && -1 < (e = g ? Ua.call(c, r) : fa[d])) c[e] = !(k[e] = r)
                    }
                } else j = Ta(j === k ? j.splice(l, j.length) : j), g ? g(null, k, j, n) : Ga.apply(k, j)
            })
        },
        Wb = function (f) {
            var a, p, b, g = f.length,
                c = G.relative[f[0].type];
            p = c || G.relative[" "];
            for (var k = c ? 1 : 0, d = Tb(function (f) {
                    return f === a
                }, p, !0), n = Tb(function (f) {
                    return -1 <
                        Ua.call(a, f)
                }, p, !0), e = [function (f, p, b) {
                    return !c && (b || p !== Aa) || ((a = p).nodeType ? d(f, p, b) : n(f, p, b))
                }]; k < g; k++)
                if (p = G.relative[f[k].type]) e = [Tb(Ub(e), p)];
                else {
                    p = G.filter[f[k].type].apply(null, f[k].matches);
                    if (p[M]) {
                        for (b = ++k; b < g && !G.relative[f[b].type]; b++);
                        return Vb(1 < k && Ub(e), 1 < k && vb(f.slice(0, k - 1).concat({
                            value: " " === f[k - 2].type ? "*" : ""
                        })).replace(wb, "$1"), p, k < b && Wb(f.slice(k, b)), b < g && Wb(f = f.slice(b)), b < g && vb(f))
                    }
                    e.push(p)
                } return Ub(e)
        },
        ...
        Ia = function (f, a, p) {
            f = "0x" + a - 65536;
            return f !== f || p ? a : 0 > f ? String.fromCharCode(f + 65536) : String.fromCharCode(f >> 10 | 55296, f & 1023 | 56320)
        };
    try {
        Ga.apply(N = tc.call(W.childNodes), W.childNodes), N[W.childNodes.length].nodeType
    } catch (Zd) {
        Ga = {
            apply: N.length ? function (f, a) {
                nd.apply(f, tc.call(a))
            } : function (f, a) {
                for (var p = f.length, b = 0; f[p++] = a[b++];);
                f.length = p - 1
            }
        }
    }
    H = D.support = {};
    rc = D.isXML = function (f) {
        return (f = f && (f.ownerDocument || f).documentElement) ? "HTML" !== f.nodeName : !1
    };
    oa = D.setDocument = function (f) {
        var a = f ? f.ownerDocument || f : W;
        f = a.defaultView;
        if (a === R || 9 !== a.nodeType || !a.documentElement) return R;
        R = a;
        ja = a.documentElement;
        X = !rc(a);
        f && f !== f.top && (f.addEventListener ? f.addEventListener("unload", function () {
            oa()
        }, !1) : f.attachEvent && f.attachEvent("onunload", function () {
            oa()
        }));
        H.attributes = qa(function (f) {
            f.className =
                "i";
            return !f.getAttribute("className")
        });
        H.getElementsByTagName = qa(function (f) {
            f.appendChild(a.createComment(""));
            return !f.getElementsByTagName("*").length
        });
        H.getElementsByClassName = lb.test(a.getElementsByClassName) && qa(function (f) {
            f.innerHTML = "<div class='a'></div><div class='a i'></div>";
            f.firstChild.className = "i";
            return 2 === f.getElementsByClassName("i").length
        });
        H.getById = qa(function (f) {
            ja.appendChild(f).id = M;
            return !a.getElementsByName || !a.getElementsByName(M).length
        });
        H.getById ? (G.find.ID = function (f,
            a) {
            if (typeof a.getElementById !== T && X) {
                var b = a.getElementById(f);
                return b && b.parentNode ? [b] : []
            }
        }, G.filter.ID = function (f) {
            var a = f.replace(Ha, Ia);
            return function (f) {
                return f.getAttribute("id") === a
            }
        }) : (delete G.find.ID, G.filter.ID = function (f) {
            var a = f.replace(Ha, Ia);
            return function (f) {
                return (f = typeof f.getAttributeNode !== T && f.getAttributeNode("id")) && f.value === a
            }
        });
        G.find.TAG = H.getElementsByTagName ? function (f, a) {
            if (typeof a.getElementsByTagName !== T) return a.getElementsByTagName(f)
        } : function (f, a) {
            var b,
                v = [],
                g = 0,
            ...
            if ("*" === f) {
                for (; b = c[g++];) 1 === b.nodeType && v.push(b);
                return v
            }
            return c
        };
        G.find.CLASS = H.getElementsByClassName && function (f, a) {
            if (typeof a.getElementsByClassName !== T && X) return a.getElementsByClassName(f)
        };
        da = [];
        S = [];
        if (H.qsa = lb.test(a.querySelectorAll)) qa(function (f) {
            f.innerHTML = "<select t=''><option selected=''></option></select>";
            f.querySelectorAll("[t^='']").length && S.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");
            f.querySelectorAll("[selected]").length || S.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
            f.querySelectorAll(":checked").length || S.push(":checked")
        }), qa(function (f) {
            var b = a.createElement("input");
            b.setAttribute("type", "hidden");
            f.appendChild(b).setAttribute("name", "D");
            f.querySelectorAll("[name=d]").length && S.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");
            f.querySelectorAll(":enabled").length || S.push(":enabled", ":disabled");
        ...
        qa(function (f) {
            H.disconnectedMatch = La.call(f, "div");
            La.call(f, "[s!='']:x");
            da.push("!=", Xb)
        });
        S = S.length && RegExp(S.join("|"));
        da = da.length && RegExp(da.join("|"));
        sa = (f = lb.test(ja.compareDocumentPosition)) || lb.test(ja.contains) ? function (f, a) {
            var b = 9 === f.nodeType ? f.documentElement : f,
                v = a && a.parentNode;
            return f === v || !(!v || !(1 === v.nodeType && (b.contains ? b.contains(v) : f.compareDocumentPosition && f.compareDocumentPosition(v) & 16)))
        } : function (f, a) {
            if (a)
                for (; a = a.parentNode;)
                    if (a === f) return !0;
        ...
        A = f ? function (f,
            b) {
            if (f === b) return Ca = !0, 0;
            var g = !f.compareDocumentPosition - !b.compareDocumentPosition;
            if (g) return g;
            g = (f.ownerDocument || f) === (b.ownerDocument || b) ? f.compareDocumentPosition(b) : 1;
            return g & 1 || !H.sortDetached && b.compareDocumentPosition(f) === g ? f === a || f.ownerDocument === W && sa(W, f) ? -1 : b === a || b.ownerDocument === W && sa(W, b) ? 1 : ra ? Ua.call(ra, f) - Ua.call(ra, b) : 0 : g & 4 ? -1 : 1
        } : function (f, b) {
            if (f === b) return Ca = !0, 0;
            var g, c = 0;
            g = f.parentNode;
            var k = b.parentNode,
                d = [f],
                n = [b];
            if (!g || !k) return f === a ? -1 : b === a ? 1 : g ? -1 : k ? 1 : ra ? Ua.call(ra,
                f) - Ua.call(ra, b) : 0;
            if (g === k) return pc(f, b);
            for (g = f; g = g.parentNode;) d.unshift(g);
            for (g = b; g = g.parentNode;) n.unshift(g);
            for (; d[c] === n[c];) c++;
            return c ? pc(d[c], n[c]) : d[c] === W ? -1 : n[c] === W ? 1 : 0
        };
        return a
    };
    D.matches = function (f, a) {
        return D(f, null, null, a)
    };
    D.matchesSelector = function (f, a) {
        (f.ownerDocument || f) !== R && oa(f);
        a = a.replace(od, "='$1']");
        if (H.matchesSelector && X && (!da || !da.test(a)) && (!S || !S.test(a))) try {
            var b = La.call(f, a);
            if (b || H.disconnectedMatch || f.document && 11 !== f.document.nodeType) return b
        } catch (g) {}
        return 0 <
            D(a, R, null, [f]).length
    };
    ...
    D.attr = function (f, a) {
        ...
        var b = G.attrHandle[a.toLowerCase()],
            b = b && ea.call(G.attrHandle, a.toLowerCase()) ? b(f, a, !X) : void 0;
        return void 0 !== b ? b : H.attributes || !X ? f.getAttribute(a) : (b = f.getAttributeNode(a)) && b.specified ? b.value : null
    };
    D.error = function (f) {
    ...
    D.uniqueSort = function (f) {
        ...
        ra = !H.sortStable && f.slice(0);
        f.sort(A);
        if (Ca) {
            for (; a = f[c++];) a === f[c] && (g = b.push(c));
            for (; g--;) f.splice(b[g], 1)
        }
        ra = null;
        return f
    };
    Ka = D.getText = function (f) {
        var a, b = "",
            g = 0;
        if (a = f.nodeType)
            if (1 === a || 9 === a || 11 === a) {
                if ("string" === typeof f.textContent) return f.textContent;
                for (f = f.firstChild; f; f = f.nextSibling) b += Ka(f)
            } else {
                if (3 === a || 4 === a) return f.nodeValue
            }
        else
            for (; a = f[g++];) b += Ka(a);
        return b
    ...
    G = D.selectors = {
        ...
        preFilter: {
            ATTR: function (f) {
                f[1] = f[1].replace(Ha, Ia);
                f[3] = (f[4] || f[5] || "").replace(Ha, Ia);
                "~=" === f[2] && (f[3] = " " + f[3] + " ");
                return f.slice(0, 4)
            },
            CHILD: function (f) {
                f[1] = f[1].toLowerCase();
                "nth" === f[1].slice(0, 3) ? (f[3] || D.error(f[0]), f[4] = +(f[4] ? f[5] + (f[6] || 1) : 2 * ("even" === f[3] || "odd" === f[3])), f[5] = +(f[7] + f[8] || "odd" === f[3])) : f[3] && D.error(f[0]);
                return f
            },
            PSEUDO: function (f) {
                var a, b = !f[5] && f[2];
                if (xb.CHILD.test(f[0])) return null;
                if (f[3] && void 0 !== f[4]) f[2] = f[4];
                else if (b && pd.test(b) && (a = ta(b, !0)) && (a = b.indexOf(")", b.length - a) - b.length)) f[0] = f[0].slice(0, a), f[2] = b.slice(0, a);
                return f.slice(0, 3)
            }
        },
        filter: {
            TAG: function (f) {
                var a = f.replace(Ha, Ia).toLowerCase();
                return "*" === f ? function () {
                    return !0
                } : function (f) {
                    return f.nodeName && f.nodeName.toLowerCase() === a
                }
            },
            CLASS: function (f) {
                var a = sc[f + " "];
                return a || (a = RegExp("(^|[\\x20\\t\\r\\n\\f])" + f + "([\\x20\\t\\r\\n\\f]|$)")) && sc(f, function (f) {
                    return a.test("string" === typeof f.className &&
                        f.className || typeof f.getAttribute !== T && f.getAttribute("class") || "")
                })
            },
            ATTR: function (f, a, b) {
                return function (g) {
                    ...
                    if (!a) return !0;
                    g += "";
                    return "=" === a ? g === b : "!=" === a ? g !== b : "^=" === a ? b && 0 === g.indexOf(b) : "*=" === a ? b && -1 < g.indexOf(b) : "$=" === a ? b && g.slice(-b.length) === b : "~=" === a ? -1 < (" " + g + " ").indexOf(b) : "|=" === a ? g === b || g.slice(0, b.length + 1) === b + "-" : !1
                }
            },
            CHILD: function (f, a, b, g, c) {
                var k = "nth" !== f.slice(0, 3),
                    d = "last" !== f.slice(-4),
                    n = "of-type" === a;
                return 1 === g && 0 === c ? function (f) {
                        return !!f.parentNode
                    } :
                    function (a, b, p) {
                        var v, e, r, j, h;
                        ...
                        if (q) {
                            if (k) {
                                for (; b;) {
                                    ...
                                    h = b = "only" === f && !h && "nextSibling"
                                }
                                return !0
                            }
                            h = [d ? q.firstChild : q.lastChild];
                            if (d && p) {
                                p = q[M] || (q[M] = {});
                                v = p[f] || [];
                                j = v[0] === ca && v[1];
                                r = v[0] === ca && v[2];
                                for (e = j && q.childNodes[j]; e = ++j && e && e[b] || (r = j = 0) || h.pop();)
                                ...
                                for (; e = ++j && e && e[b] || (r = j = 0) || h.pop();)
                                    if ((n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) && ++r)
                                        if (p && ((e[M] || (e[M] = {}))[f] = [ca, r]), e === a) break;
                            r -= c;
                            return r === g || 0 === r % g && 0 <= r / g
                        }
                    }
            },
            PSEUDO: function (f, a) {
                var b, g = G.pseudos[f] || G.setFilters[f.toLowerCase()] || D.error("unsupported pseudo: " + f);
                return g[M] ? g(a) : 1 < g.length ? (b = [f, f, "", a], G.setFilters.hasOwnProperty(f.toLowerCase()) ? pa(function (f, b) {
                        for (var p, c = g(f, a), k = c.length; k--;) p = Ua.call(f, c[k]), f[p] = !(b[p] = c[k])
                    }) :
                    function (f) {
                        return g(f, 0, b)
                    }) : g
        ...
        pseudos: {
            not: pa(function (f) {
                var a = [],
                    b = [],
                    g = $a(f.replace(wb, "$1"));
                return g[M] ? pa(function (f, a, b, p) {
                    p = g(f, null, p, []);
            ...
            has: pa(function (f) {
                return function (a) {
                    return 0 < D(f, a).length
                }
            }),
            contains: pa(function (f) {
                return function (a) {
                    return -1 < (a.textContent || a.innerText || Ka(a)).indexOf(f)
                }
            }),
            lang: pa(function (f) {
                qd.test(f || "") || D.error("unsupported lang: " + f);
                f = f.replace(Ha,
                    Ia).toLowerCase();
                return function (a) {
                    var b;
                    do
                        if (b = X ? a.lang : a.getAttribute("xml:lang") || a.getAttribute("lang")) return b = b.toLowerCase(), b === f || 0 === b.indexOf(f + "-"); while ((a = a.parentNode) && 1 === a.nodeType);
                    return !1
                }
            }),
            target: function (f) {
                var a = Pb.location && Pb.location.hash;
                return a && a.slice(1) === f.id
            },
            root: function (f) {
                return f === ja
            },
            focus: function (f) {
                return f === R.activeElement && (!R.hasFocus || R.hasFocus()) && !(!f.type && !f.href && !~f.tabIndex)
            },
            enabled: function (f) {
                return !1 === f.disabled
            },
            ...
            checked: function (f) {
                ...
                return "input" === a && !!f.checked || "option" === a && !!f.selected
            },
            selected: function (f) {
            ...
            header: function (f) {
                return sd.test(f.nodeName)
            },
            input: function (f) {
                return rd.test(f.nodeName)
            },
            button: function (f) {
                var a = f.nodeName.toLowerCase();
                return "input" ===
                    a && "button" === f.type || "button" === a
            },
            text: function (f) {
                var a;
                return "input" === f.nodeName.toLowerCase() && "text" === f.type && (null == (a = f.getAttribute("type")) || "text" === a.toLowerCase())
            },
            first: ua(function () {
                return [0]
            }),
            last: ua(function (f, a) {
                return [a - 1]
            }),
            eq: ua(function (f, a, b) {
                return [0 > b ? b + a : b]
            }),
            even: ua(function (f, a) {
                for (var b = 0; b < a; b += 2) f.push(b);
                return f
            }),
            odd: ua(function (f, a) {
                for (var b = 1; b < a; b += 2) f.push(b);
                return f
            }),
            lt: ua(function (f, a, b) {
                for (a = 0 > b ? b + a : b; 0 <= --a;) f.push(a);
                return f
            }),
            gt: ua(function (f,
                a, b) {
                for (b = 0 > b ? b + a : b; ++b < a;) f.push(b);
                return f
            })
        }
    };
    ...
    G.setFilters = new qc;
    $a = D.compile = function (f, a) {
        var b, g = [],
            c = [],
            k = Da[f + " "];
        if (!k) {
            a || (a = ta(f));
            for (b = a.length; b--;) k = Wb(a[b]), k[M] ? g.push(k) : c.push(k);
            var d = 0 < g.length,
                n = 0 < c.length;
            b = function (f, a, b, p, v) {
                var k, e, r, j = 0,
                    fa = "0",
                    h = f && [],
                    q = [],
                ...
                for (v && (Aa = a !== R && a); fa !== T && null != (k = A[fa]); fa++) {
                    ...
                    d && ((k = !r && k) && j--, f && h.push(k))
                }
                j += fa;
                if (d && fa !== j) {
                    for (e = 0; r = g[e++];) r(h, q, a, b);
                    if (f) {
                        if (0 < j)
                            for (; fa--;) !h[fa] && !q[fa] && (q[fa] = Y.call(p));
                        q = Ta(q)
                    }
                    Ga.apply(p, q);
                    v && (!f && 0 < q.length && 1 < j + g.length) && D.uniqueSort(p)
                }
                v && (ca = z, Aa = l);
                return h
            };
    ...
    oa();
    H.sortDetached = qa(function (f) {
        return f.compareDocumentPosition(R.createElement("div")) & 1
    });
    qa(function (f) {
        f.innerHTML = "<a href='#'></a>";
        return "#" === f.firstChild.getAttribute("href")
    }) || Sb("type|href|height|width", function (f, a, b) {
        if (!b) return f.getAttribute(a, "type" === a.toLowerCase() ? 1 : 2)
    });
    (!H.attributes || !qa(function (f) {
        f.innerHTML = "<input/>";
        f.firstChild.setAttribute("value", "");
        return "" === f.firstChild.getAttribute("value")
    })) && Sb("value", function (f, a, b) {
        if (!b && "input" === f.nodeName.toLowerCase()) return f.defaultValue
    });
    qa(function (f) {
        return null == f.getAttribute("disabled")
    }) || Sb("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", function (f, a, b) {
        var g;
        if (!b) return !0 === f[a] ? a.toLowerCase() : (g = f.getAttributeNode(a)) && g.specified ? g.value : null
    });
    g.find = D;
    g.expr = D.selectors;
    ...
    var wc = g.expr.match.needsContext,
        xc = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        Vc =
        /^.[^:#\[\.,]*$/;
    g.filter = function (f, a, b) {
        var c = a[0];
        b && (f = ":not(" + f + ")");
        return 1 === a.length && 1 === c.nodeType ? g.find.matchesSelector(c, f) ? [c] : [] : g.find.matches(f, g.grep(a, function (f) {
            return 1 === f.nodeType
        }))
    };
    g.fn.extend({
        find: function (f) {
            var a, b = [],
                c = this,
                k = c.length;
            if ("string" !== typeof f) return this.pushStack(g(f).filter(function () {
                for (a = 0; a < k; a++)
                    if (g.contains(c[a], this)) return !0
            }));
            for (a = 0; a < k; a++) g.find(f, c[a], b);
            b = this.pushStack(1 < k ? g.unique(b) : b);
            b.selector = this.selector ? this.selector + " " +
                f : f;
            return b
        },
        filter: function (f) {
            return this.pushStack(h(this, f || [], !1))
        },
        not: function (f) {
            return this.pushStack(h(this, f || [], !0))
        },
        is: function (f) {
            return !!h(this, "string" === typeof f && wc.test(f) ? g(f) : f || [], !1).length
        }
    });
    var mb, y = a.document,
        td = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (g.fn.init = function (f, a) {
        var b, c;
        if (!f) return this;
        if ("string" === typeof f) {
            if ((b = "<" === f.charAt(0) && ">" === f.charAt(f.length - 1) && 3 <= f.length ? [null, f, null] : td.exec(f)) && (b[1] || !a)) {
                if (b[1]) {
                    if (a = a instanceof g ? a[0] : a, g.merge(this,
                            g.parseHTML(b[1], a && a.nodeType ? a.ownerDocument || a : y, !0)), xc.test(b[1]) && g.isPlainObject(a))
                        for (b in a)
                            if (g.isFunction(this[b])) this[b](a[b]);
                            else this.attr(b, a[b])
                } else {
                    if ((c = y.getElementById(b[2])) && c.parentNode) {
                        if (c.id !== b[2]) return mb.find(f);
                        this.length = 1;
                        this[0] = c
                    }
                    this.context = y;
            ...
            return !a || a.jquery ? (a || mb).find(f) : this.constructor(a).find(f)
        }
        if (f.nodeType) return this.context = this[0] = f, this.length = 1, this;
        if (g.isFunction(f)) return "undefined" !== typeof mb.ready ? mb.ready(f) :
            f(g);
        void 0 !== f.selector && (this.selector = f.selector, this.context = f.context);
    ...
    g.extend({
        dir: function (f, a, b) {
            var c = [];
            for (f = f[a]; f && 9 !== f.nodeType && (void 0 === b || 1 !== f.nodeType || !g(f).is(b));) 1 === f.nodeType && c.push(f), f = f[a];
            return c
        },
        sibling: function (f, a) {
            for (var b = []; f; f = f.nextSibling) 1 === f.nodeType && f !== a && b.push(f);
            return b
        }
    });
    g.fn.extend({
        ...
        closest: function (f, a) {
            for (var b, c = 0, k = this.length, d = [], n = wc.test(f) || "string" !== typeof f ? g(f, a || this.context) : 0; c < k; c++)
                for (b = this[c]; b && b !== a; b = b.parentNode)
                    if (11 > b.nodeType && (n ? -1 < n.index(b) : 1 === b.nodeType && g.find.matchesSelector(b, f))) {
                        d.push(b);
                        break
                    } return this.pushStack(1 < d.length ? g.unique(d) : d)
        },
        index: function (f) {
            return !f ? this[0] && this[0].parentNode ? this.first().prevAll().length : -1 : "string" ===
                typeof f ? g.inArray(this[0], g(f)) : g.inArray(f.jquery ? f[0] : f, this)
        },
        add: function (f, a) {
            return this.pushStack(g.unique(g.merge(this.get(), g(f, a))))
        },
        addBack: function (f) {
    ...
    g.each({
        ...
        parents: function (f) {
            return g.dir(f, "parentNode")
        },
        parentsUntil: function (f, a, b) {
            return g.dir(f, "parentNode", b)
        },
        next: function (f) {
            return e(f, "nextSibling")
        },
        prev: function (f) {
            return e(f, "previousSibling")
        },
        nextAll: function (f) {
            return g.dir(f, "nextSibling")
        },
        prevAll: function (f) {
            return g.dir(f, "previousSibling")
        },
        nextUntil: function (f, a, b) {
            return g.dir(f, "nextSibling", b)
        },
        prevUntil: function (f, a, b) {
            return g.dir(f, "previousSibling", b)
        },
        siblings: function (f) {
            return g.sibling((f.parentNode || {}).firstChild, f)
        },
        children: function (f) {
            return g.sibling(f.firstChild)
        },
        contents: function (f) {
            return g.nodeName(f, "iframe") ? f.contentDocument || f.contentWindow.document : g.merge([], f.childNodes)
        }
    }, function (f, a) {
        g.fn[f] = function (b,
            c) {
            var k = g.map(this, a, b);
            "Until" !== f.slice(-5) && (c = b);
            c && "string" === typeof c && (k = g.filter(c, k));
            1 < this.length && (vd[f] || (k = g.unique(k)), ud.test(f) && (k = k.reverse()));
    ...
    g.Callbacks = function (f) {
        ...
        if ("string" === typeof f) {
            if (!(a = yc[f])) {
                a = f;
                var b = yc[a] = {};
                g.each(a.match(xa) || [], function (f, a) {
                    b[a] = !0
                });
                a = b
            }
        ...
        var c, k, d, n, e, r, j = [],
            ...
            q = function (a) {
                ...
                j && (h ? h.length && q(h.shift()) : k ? j = [] : l.disable())
            },
            l = {
                add: function () {
                    if (j) {
                        ...
                        (function $c(a) {
                            g.each(a, function (a, b) {
                                var p = g.type(b);
                                "function" === p ? (!f.unique || !l.has(b)) && j.push(b) : b && (b.length && "string" !== p) && $c(b)
                            })
                        })(arguments);
                        c ? n = j.length : k && (r = a, q(k))
                    }
                    return this
                },
                remove: function () {
                    j && g.each(arguments, function (f, a) {
                        for (var b; - 1 < (b = g.inArray(a, j, b));) j.splice(b, 1), c && (b <= n && n--, b <= e && e--)
                    });
                    return this
                },
                has: function (f) {
                    return f ? -1 < g.inArray(f,
                        j) : !(!j || !j.length)
                },
                empty: function () {
                    j = [];
                ...
                fireWith: function (f, a) {
                    if (j && (!d || h)) a = a || [], a = [f, a.slice ? a.slice() : a], c ? h.push(a) : q(a);
                    return this
                },
                fire: function () {
    ...
    g.extend({
                ...
                c = {
                    ...
                    then: function () {
                        ...
                        return g.Deferred(function (b) {
                            g.each(a, function (a, p) {
                                var v = g.isFunction(f[a]) && f[a];
                                k[p[1]](function () {
                                    var f = v && v.apply(this, arguments);
                                    if (f && g.isFunction(f.promise)) f.promise().done(b.resolve).fail(b.reject).progress(b.notify);
                    ...
                    promise: function (f) {
                        return null != f ? g.extend(f, c) : c
                    }
                },
                k = {};
            c.pipe = c.then;
            g.each(a, function (f, g) {
                var d = g[2],
                    n = g[3];
                c[g[1]] = d.add;
                n && d.add(function () {
                    b = n
                }, a[f ^ 1][2].disable, a[2][2].lock);
                k[g[0]] = function () {
                    k[g[0] + "With"](this === k ? c : this, arguments);
                    return this
                };
                k[g[0] + "With"] = d.fireWith
            });
            c.promise(k);
            f && f.call(k, k);
            return k
        ...
        when: function (f) {
            var a = 0,
                b = n.call(arguments),
                c = b.length,
                k = 1 !== c || f && g.isFunction(f.promise) ? c : 0,
                d = 1 === k ? f : g.Deferred(),
                e = function (f,
                    a, b) {
                    return function (g) {
                        a[f] = this;
                        b[f] = 1 < arguments.length ? n.call(arguments) : g;
            ...
            if (1 < c) {
                r = Array(c);
                j = Array(c);
                for (h = Array(c); a < c; a++) b[a] && g.isFunction(b[a].promise) ? b[a].promise().done(e(a, h, b)).fail(d.reject).progress(e(a, j, r)) : --k
            }
            k || d.resolveWith(h, b);
            return d.promise()
        }
    ...
    g.extend({
        ...
        ready: function (f) {
            if (!(!0 ===
                    f ? --g.readyWait : g.isReady)) {
                if (!y.body) return setTimeout(g.ready);
                g.isReady = !0;
                !0 !== f && 0 < --g.readyWait || (yb.resolveWith(y, [g]), g.fn.trigger && g(y).trigger("ready").off("ready"))
            }
        }
    });
    g.ready.promise = function (f) {
        if (!yb)
            if (yb = g.Deferred(), "complete" === y.readyState) setTimeout(g.ready);
    ...
    g.acceptData = function (f) {
        var a = g.noData[(f.nodeName + " ").toLowerCase()],
            b = +f.nodeType || 1;
        return 1 !== b && 9 !== b ? !1 : !a || !0 !== a && f.getAttribute("classid") === a
    };
    var Xc = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
        Wc = /([A-Z])/g;
    g.extend({
        ...
        hasData: function (f) {
            f = f.nodeType ? g.cache[f[g.expando]] : f[g.expando];
            return !!f && !u(f)
        },
        data: function (f, a, g) {
            return b(f, a, g)
        },
        removeData: function (f, a) {
            return c(f, a)
        },
        _data: function (f, a, g) {
            return b(f, a, g, !0)
        },
        _removeData: function (f, a) {
            return c(f, a, !0)
        }
    });
    g.fn.extend({
        data: function (f, a) {
            var b, c, k, d = this[0],
                n = d && d.attributes;
            if (void 0 === f) {
                if (this.length && (k = g.data(d), 1 === d.nodeType && !g._data(d, "parsedAttrs"))) {
                    for (b = n.length; b--;) c = n[b].name,
                        0 === c.indexOf("data-") && (c = g.camelCase(c.slice(5)), s(d, c, k[c]));
    ...
    g.extend({
        queue: function (f, a, b) {
            var c;
            if (f) return a = (a || "fx") + "queue", c = g._data(f, a), b && (!c || g.isArray(b) ? c = g._data(f, a, g.makeArray(b)) : c.push(b)), c || []
        },
        dequeue: function (f,
            a) {
            a = a || "fx";
            ...
            k && ("fx" === a && b.unshift("inprogress"), delete d.stop, k.call(f, n, d));
            !c && d && d.empty.fire()
        },
        _queueHooks: function (f, a) {
            var b = a + "queueHooks";
            return g._data(f, b) || g._data(f, b, {
                empty: g.Callbacks("once memory").add(function () {
                    g._removeData(f, a + "queue");
                    g._removeData(f, b)
                })
            })
        }
    ...
    g.fn.extend({
        queue: function (f, a) {
            var b = 2;
            "string" !== typeof f && (a = f, f = "fx", b--);
            return arguments.length <
                b ? g.queue(this[0], f) : void 0 === a ? this : this.each(function () {
                    var b = g.queue(this, f, a);
                    g._queueHooks(this, f);
                    "fx" === f && "inprogress" !== b[0] && g.dequeue(this, f)
                })
        },
        dequeue: function (f) {
            return this.each(function () {
        ...
        promise: function (f, a) {
            ...
            "string" !== typeof f && (a = f, f = void 0);
            for (f = f || "fx"; n--;)
                if ((b = g._data(d[n], f + "queueHooks")) && b.empty) c++, b.empty.add(e);
            e();
            return k.promise(a)
        }
    });
    var zb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Va = g.access = function (a, b, c, k, d, n, e) {
            var r = 0,
                j = a.length,
                h = null == c;
            if ("object" === g.type(c))
                for (r in d = !0, c) g.access(a, b, r, c[r], !0, n, e);
            else if (void 0 !== k && (d = !0, g.isFunction(k) || (e = !0), h && (e ? (b.call(a, k), b = null) : (h = b, b = function (a, f, b) {
                    return h.call(g(a), b)
                })), b))
                for (; r < j; r++) b(a[r], c, e ? k : k.call(a[r],
                    r, b(a[r], c)));
            return d ? a : h ? b.call(a) : j ? b(a[0], c) : n
        },
        Mb = /^(?:checkbox|radio)$/i,
    ...
    g.event = {
        ...
        add: function (a, b, c, k, d) {
            var n, e, r, j, h, q, l, A, z;
            if (r = g._data(a)) {
                c.handler && (j = c, c = j.handler, d = j.selector);
                c.guid || (c.guid = g.guid++);
                if (!(e = r.events)) e =
                    r.events = {};
                if (!(h = r.handle)) h = r.handle = function (a) {
                    return typeof g !== la && (!a || g.event.triggered !== a.type) ? g.event.dispatch.apply(h.elem, arguments) : void 0
                }, h.elem = a;
                b = (b || "").match(xa) || [""];
                for (r = b.length; r--;)
                    if (n = Cc.exec(b[r]) || [], A = q = n[1], z = (n[2] || "").split(".").sort(), A) {
                        n = g.event.special[A] || {};
                        ...
                        q = g.extend({
                            ...
                            j);
                        if (!(l = e[A]))
                            if (l = e[A] = [], l.delegateCount = 0, !n.setup || !1 === n.setup.call(a, k, z, h)) a.addEventListener ? a.addEventListener(A, h, !1) : a.attachEvent && a.attachEvent("on" + A, h);
                        n.add && (n.add.call(a, q), q.handler.guid || (q.handler.guid = c.guid));
                        d ? l.splice(l.delegateCount++, 0, q) : l.push(q);
                        g.event.global[A] = !0
                    } a = null
            }
        },
        remove: function (a, b, c, k, d) {
            var n, e, r, j, h, q, l, A, z, T, t, m = g.hasData(a) && g._data(a);
            if (m && (q = m.events)) {
                b = (b || "").match(xa) || [""];
                for (h = b.length; h--;)
                    if (r = Cc.exec(b[h]) || [], z = t = r[1], T = (r[2] || "").split(".").sort(),
                        z) {
                        l = g.event.special[z] || {};
                        ...
                        j && !A.length && ((!l.teardown || !1 === l.teardown.call(a, T, m.handle)) && g.removeEvent(a, z, m.handle), delete q[z])
                    } else
                        for (z in q) g.event.remove(a, z + b[h], c,
                            k, !0);
                g.isEmptyObject(q) && (delete m.handle, g._removeData(a, "events"))
            }
        },
        trigger: function (f, b, c, k) {
            var d, n, e, r, j, h, q = [c || y],
                l = za.call(f, "type") ? f.type : f;
            j = za.call(f, "namespace") ? f.namespace.split(".") : [];
            e = d = c = c || y;
            if (!(3 === c.nodeType || 8 === c.nodeType) && !Bc.test(l + g.event.triggered))
                if (0 <= l.indexOf(".") && (j = l.split("."), l = j.shift(), j.sort()), n = 0 > l.indexOf(":") && "on" + l, f = f[g.expando] ? f : new g.Event(l, "object" === typeof f && f), f.isTrigger = k ? 2 : 3, f.namespace = j.join("."), f.namespace_re = f.namespace ? RegExp("(^|\\.)" +
                        j.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, f.result = void 0, f.target || (f.target = c), b = null == b ? [f] : g.makeArray(b, [f]), j = g.event.special[l] || {}, k || !(j.trigger && !1 === j.trigger.apply(c, b))) {
                    if (!k && !j.noBubble && !g.isWindow(c)) {
                        r = j.delegateType || l;
                        Bc.test(r + l) || (e = e.parentNode);
                        for (; e; e = e.parentNode) q.push(e), d = e;
                        if (d === (c.ownerDocument || y)) q.push(d.defaultView || d.parentWindow || a)
                    }
                    for (h = 0;
                        (e = q[h++]) && !f.isPropagationStopped();)
                        if (f.type = 1 < h ? r : j.bindType || l, (d = (g._data(e, "events") || {})[f.type] && g._data(e, "handle")) &&
                            d.apply(e, b), (d = n && e[n]) && d.apply && g.acceptData(e)) f.result = d.apply(e, b), !1 === f.result && f.preventDefault();
                    f.type = l;
                    if (!k && !f.isDefaultPrevented() && (!j._default || !1 === j._default.apply(q.pop(), b)) && g.acceptData(c) && n && c[l] && !g.isWindow(c)) {
                        (d = c[n]) && (c[n] = null);
                        g.event.triggered = l;
                        try {
                            c[l]()
        ...
        dispatch: function (a) {
            ...
            var j = g.event.special[a.type] || {};
            r[0] = a;
            a.delegateTarget = this;
            if (!(j.preDispatch && !1 === j.preDispatch.call(this, a))) {
                e = g.event.handlers.call(this, a, b);
                for (b = 0;
                    ...
                    for (d = 0;
                        ...
                        if (!a.namespace_re || a.namespace_re.test(c.namespace))
                            if (a.handleObj = c, a.data = c.data, c = ((g.event.special[c.origType] || {}).handle || c.handler).apply(k.elem, r), void 0 !== c && !1 === (a.result = c)) a.preventDefault(), a.stopPropagation()
                }
        ...
        handlers: function (a, b) {
            var c, k, d, n, e = [],
                r = b.delegateCount,
                j = a.target;
            if (r && j.nodeType && (!a.button || "click" !== a.type))
                for (; j != this; j = j.parentNode || this)
                    if (1 === j.nodeType && (!0 !== j.disabled || "click" !== a.type)) {
                        d = [];
                        for (n = 0; n < r; n++) k = b[n], c = k.selector + " ", void 0 === d[c] && (d[c] = k.needsContext ? 0 <= g(c, this).index(j) : g.find(c, this, null, [j]).length), d[c] && d.push(k);
                        d.length && e.push({
                            elem: j,
                            handlers: d
                        })
        ...
        mouseHooks: {
            ...
            filter: function (a, b) {
                ...
                null == a.pageX && null != b.clientX && (g = a.target.ownerDocument || y, c = g.documentElement, g = g.body, a.pageX = b.clientX + (c && c.scrollLeft || g && g.scrollLeft || 0) - (c && c.clientLeft ||
                    g && g.clientLeft || 0), a.pageY = b.clientY + (c && c.scrollTop || g && g.scrollTop || 0) - (c && c.clientTop || g && g.clientTop || 0));
        ...
        simulate: function (a, b, c, k) {
            ...
            k ? g.event.trigger(a, null, b) : g.event.dispatch.call(b, a);
            a.isDefaultPrevented() && c.preventDefault()
        }
    };
    g.removeEvent = y.removeEventListener ? function (a, b, g) {
        a.removeEventListener && a.removeEventListener(b,
            g, !1)
    } : function (a, b, g) {
        b = "on" + b;
        a.detachEvent && (typeof a[b] === la && (a[b] = null), a.detachEvent(b, g))
    };
        ...
        g.event.special[a] = {
            ...
            handle: function (a) {
                var f, c = a.relatedTarget,
                    k = a.handleObj;
                if (!c || c !== this && !g.contains(this, c)) a.type = k.origType, f = k.handler.apply(this, arguments), a.type = b;
                return f
            }
        }
    });
    w.submitBubbles || (g.event.special.submit = {
        setup: function () {
            if (g.nodeName(this, "form")) return !1;
            g.event.add(this, "click._submit keypress._submit", function (a) {
                a = a.target;
                if ((a = g.nodeName(a, "input") || g.nodeName(a, "button") ? a.form : void 0) && !g._data(a, "submitBubbles")) g.event.add(a, "submit._submit", function (a) {
                    a._submit_bubble = !0
    ...
    w.changeBubbles || (g.event.special.change = {
        setup: function () {
            ...
            g.event.add(this, "beforeactivate._change", function (a) {
                a = a.target;
                Zb.test(a.nodeName) && !g._data(a, "changeBubbles") && (g.event.add(a, "change._change", function (a) {
        ...
        g.event.special[b] = {
            ...
            teardown: function () {
                var k =
                    ...
                    d = g._data(k, b) - 1;
                d ? g._data(k, b, d) : (k.removeEventListener(a, c, !0), g._removeData(k, b))
            }
        }
    });
    g.fn.extend({
        on: function (a, b, c, k, d) {
            ...
            }, k.guid = e.guid || (e.guid = g.guid++));
            return this.each(function () {
                g.event.add(this, a, k, c, b)
            })
        },
        one: function (a, b, g, c) {
            return this.on(a, b, g, c, 1)
        },
        off: function (a, b, c) {
            var k;
            if (a && a.preventDefault && a.handleObj) return k = a.handleObj, g(a.delegateTarget).off(k.namespace ? k.origType + "." + k.namespace : k.origType, k.selector, k.handler), this;
            if ("object" === typeof a) {
    ...
    g.extend({
        clone: function (a, b, c) {
            var k, d, n, e, r, j = g.contains(a.ownerDocument, a);
            w.html5Clone || g.isXMLDoc(a) || !Dc.test("<" + a.nodeName + ">") ? n = a.cloneNode(!0) : (ac.innerHTML = a.outerHTML, ac.removeChild(n = ac.firstChild));
            if ((!w.noCloneEvent || !w.noCloneChecked) && (1 === a.nodeType || 11 === a.nodeType) && !g.isXMLDoc(a)) {
                k = E(n);
                r = E(a);
                for (e = 0; null != (d = r[e]); ++e)
                    if (k[e]) {
                        ...
                        if (1 === h.nodeType) {
                            ...
                            if (!w.noCloneEvent && h[g.expando]) {
                                A = g._data(h);
                                for (q in A.events) g.removeEvent(h, q, A.handle);
                                h.removeAttribute(g.expando)
                            }
                            if ("script" === l && h.text !== d.text) Ea(h).text = d.text, U(h);
                            else if ("object" === l) h.parentNode && (h.outerHTML = d.outerHTML), w.html5Clone && (d.innerHTML && !g.trim(h.innerHTML)) && (h.innerHTML = d.innerHTML);
                            else if ("input" === l && Mb.test(d.type)) h.defaultChecked = h.checked = d.checked, h.value !== d.value && (h.value = d.value);
                            else if ("option" ===
                                l) h.defaultSelected = h.selected = d.defaultSelected;
                            else if ("input" === l || "textarea" === l) h.defaultValue = d.defaultValue
                        }
                    }
            }
            if (b)
            ...
            k = E(n, "script");
            0 < k.length && Q(k, !j && E(a, "script"));
            return n
        },
        buildFragment: function (a, b, c, k) {
            for (var d, n, e, r, j, h, l = a.length, q = B(b), A = [], z = 0; z < l; z++)
                if ((n = a[z]) || 0 === n)
                    if ("object" === g.type(n)) g.merge(A, n.nodeType ? [n] : n);
                    else if (Ad.test(n)) {
                e = e || q.appendChild(b.createElement("div"));
                r = (Fc.exec(n) || ["", ""])[1].toLowerCase();
                h = ka[r] || ka._default;
                e.innerHTML = h[1] + n.replace(Ec, "<$1></$2>") + h[2];
                for (d = h[0]; d--;) e = e.lastChild;
                !w.leadingWhitespace && $b.test(n) && A.push(b.createTextNode($b.exec(n)[0]));
                if (!w.tbody)
                    for (d = (n = "table" === r && !Gc.test(n) ? e.firstChild : "<table>" === h[1] && !Gc.test(n) ? e : 0) && n.childNodes.length; d--;) g.nodeName(j = n.childNodes[d], "tbody") && !j.childNodes.length && n.removeChild(j);
                g.merge(A, e.childNodes);
                for (e.textContent = ""; e.firstChild;) e.removeChild(e.firstChild);
                e = q.lastChild
            } else A.push(b.createTextNode(n));
            e && q.removeChild(e);
            w.appendChecked || g.grep(E(A, "input"), rb);
            for (z = 0; n = A[z++];)
                if (!(k && -1 !== g.inArray(n, k)) && (a = g.contains(n.ownerDocument, n), e = E(q.appendChild(n), "script"), a && Q(e), c))
                    for (d = 0; n = e[d++];) Hc.test(n.type || "") && c.push(n);
            return q
        },
        cleanData: function (a, b) {
            for (var c, d, n, e, r = 0, j = g.expando, h = g.cache, l = w.deleteExpando, q = g.event.special; null != (c = a[r]); r++)
                if (b || g.acceptData(c))
                    if (e = (n = c[j]) && h[n]) {
                        if (e.events)
                            for (d in e.events) q[d] ? g.event.remove(c, d) : g.removeEvent(c, d, e.handle);
                        h[n] && (delete h[n],
                            l ? delete c[j] : typeof c.removeAttribute !== la ? c.removeAttribute(j) : c[j] = null, k.push(n))
                    }
        }
    });
    g.fn.extend({
        text: function (a) {
            return Va(this, function (a) {
                return void 0 === a ? g.text(this) : this.empty().append((this[0] && this[0].ownerDocument || y).createTextNode(a))
        ...
        remove: function (a, b) {
            for (var c, k = a ? g.filter(a, this) : this, d = 0; null != (c = k[d]); d++) !b && 1 === c.nodeType && g.cleanData(E(c)), c.parentNode && (b && g.contains(c.ownerDocument,
                c) && Q(E(c, "script")), c.parentNode.removeChild(c));
            return this
        },
        empty: function () {
            for (var a, b = 0; null != (a = this[b]); b++) {
                for (1 === a.nodeType && g.cleanData(E(a, !1)); a.firstChild;) a.removeChild(a.firstChild);
        ...
        html: function (a) {
            return Va(this, function (a) {
                var f = this[0] || {},
                    b = 0,
                    c = this.length;
                if (void 0 === a) return 1 === f.nodeType ? f.innerHTML.replace(zd,
                    "") : void 0;
                if ("string" === typeof a && !Bd.test(a) && (w.htmlSerialize || !Dc.test(a)) && (w.leadingWhitespace || !$b.test(a)) && !ka[(Fc.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(Ec, "<$1></$2>");
                    try {
                        for (; b < c; b++) f = this[b] || {}, 1 === f.nodeType && (g.cleanData(E(f, !1)), f.innerHTML = a);
                        f = 0
                    } catch (k) {}
                }
        ...
        domManip: function (a, b) {
            ...
            var c, k, d, n, e = 0,
                ...
                q = a[0],
                A = g.isFunction(q);
            if (A || 1 < j && "string" === typeof q && !w.checkClone && Cd.test(q)) return this.each(function (c) {
                var g = h.eq(c);
                A && (a[0] = q.call(this, c, g.html()));
                g.domManip(a, b)
            });
            if (j && (n = g.buildFragment(a, this[0].ownerDocument, !1, this), c = n.firstChild, 1 === n.childNodes.length && (n = c), c)) {
                d = g.map(E(n, "script"), Ea);
                for (k = d.length; e < j; e++) c = n, e !==
                    l && (c = g.clone(c, !0, !0), k && g.merge(d, E(c, "script"))), b.call(this[e], c, e);
                if (k) {
                    n = d[d.length - 1].ownerDocument;
                    g.map(d, U);
                    for (e = 0; e < k; e++)
                        if (c = d[e], Hc.test(c.type || "") && !g._data(c, "globalEval") && g.contains(n, c)) c.src ? g._evalUrl && g._evalUrl(c.src) : g.globalEval((c.text || c.textContent || c.innerHTML || "").replace(Dd, ""))
                }
                n = c = null
            }
            return this
    ...
    g.each({
        ...
        g.fn[a] = function (a) {
            for (var f = 0, c = [],
                    k = g(a), d = k.length - 1; f <= d; f++) a = f === d ? this : this.clone(!0), g(k[f])[b](a), z.apply(c, a.get());
    ...
    a.getComputedStyle ? (Ra = function (a) {
        ...
        c && ("" === d && !g.contains(a.ownerDocument, a) && (d = g.style(a, b)), sb.test(d) && Ic.test(b) && (a = n.width, b = n.minWidth, k = n.maxWidth, n.minWidth = n.maxWidth = n.width = d, d = c.width, n.width = a, n.minWidth = b, n.maxWidth =
            k));
        return void 0 === d ? d : d + ""
        ...
        if (sb.test(d) && !Ed.test(b)) {
            c = n.left;
            if (k = (g = a.runtimeStyle) && g.left) g.left = a.currentStyle.left;
    ...
    var dc = function () {
            var f, b, c = y.getElementsByTagName("body")[0];
            c && (f = y.createElement("div"), b = y.createElement("div"),
                f.style.cssText = bc, c.appendChild(f).appendChild(b), b.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", g.swap(c, null != c.style.zoom ? {
                    zoom: 1
                } : {}, function () {
                    cc = 4 === b.offsetWidth
                }), Db = !0, Eb = !1, Fb = !0, a.getComputedStyle && (Eb = "1%" !== (a.getComputedStyle(b, null) || {}).top, Db = "4px" === (a.getComputedStyle(b, null) || {
                    width: "4px"
                }).width), c.removeChild(f), b = c = null)
        },
        pb, Gb, cc, Db, Eb, Fb,
    ...
    g.extend(w, {
        reliableHiddenOffsets: function () {
            ...
            var a, b, c;
            b = y.createElement("div");
            var g = y.getElementsByTagName("body")[0];
            if (g) return b.setAttribute("className", "t"), b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", a = y.createElement("div"), a.style.cssText = bc, g.appendChild(a).appendChild(b), b.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", b = b.getElementsByTagName("td"), b[0].style.cssText = "padding:0;margin:0;border:0;display:none", c = 0 === b[0].offsetHeight, b[0].style.display = "", b[1].style.display =
                "none", Gb = c && 0 === b[0].offsetHeight, g.removeChild(a), Gb
        },
        boxSizing: function () {
            null == cc && dc();
            return cc
        ...
        reliableMarginRight: function () {
            ...
            if (null == Fb && a.getComputedStyle) {
                ...
                g = c.appendChild(y.createElement("div"));
                g.style.cssText = c.style.cssText =
                ...
                c.style.width = "1px";
                Fb = !parseFloat((a.getComputedStyle(g, null) || {}).marginRight);
                f.removeChild(b)
            }
            return Fb
        }
    });
    g.swap = function (a, b, c, g) {
        var k, d = {};
    ...
    g.extend({
        ...
        style: function (a, b, c, k) {
            if (a && !(3 === a.nodeType ||
                ...
                var d, n, e, r = g.camelCase(b),
                    j = a.style;
                b = g.cssProps[r] || (g.cssProps[r] = gb(j, r));
                e = g.cssHooks[b] || g.cssHooks[r];
                if (void 0 !== c) {
                    n = typeof c;
                    if ("string" === n && (d = Hd.exec(c))) c = (d[1] + 1) * d[2] + parseFloat(g.css(a, b)), n = "number";
                    if (!(null == c || c !== c))
                        if ("number" === n && !g.cssNumber[r] && (c += "px"), !w.clearCloneStyle && ("" === c && 0 === b.indexOf("background")) && (j[b] = "inherit"), !e || !("set" in e) || void 0 !== (c = e.set(a, c, k))) try {
                            j[b] = "", j[b] = c
                        } catch (h) {}
        ...
        css: function (a, b, c, k) {
            var d, n;
            n = g.camelCase(b);
            b = g.cssProps[n] || (g.cssProps[n] = gb(a.style, n));
            (n = g.cssHooks[b] || g.cssHooks[n]) && "get" in n && (d = n.get(a, !0, c));
            void 0 === d && (d = Sa(a, b, k));
            "normal" === d && b in Jc && (d = Jc[b]);
            return "" === c || c ? (a = parseFloat(d), !0 === c || g.isNumeric(a) ? a || 0 : d) : d
        }
    });
    g.each(["height", "width"], function (a, b) {
        g.cssHooks[b] = {
            get: function (a, f, c) {
                if (f) return 0 === a.offsetWidth && Gd.test(g.css(a, "display")) ? g.swap(a, Id, function () {
                    return aa(a, b, c)
                }) : aa(a, b, c)
            },
            set: function (a,
                f, c) {
                var k = c && Ra(a);
                return ma(a, f, c ? x(a, b, c, w.boxSizing() && "border-box" === g.css(a, "boxSizing", !1, k), k) : 0)
            }
        }
    });
    w.opacity || (g.cssHooks.opacity = {
        get: function (a, b) {
        ...
        set: function (a, b) {
            var c = a.style,
                k = a.currentStyle,
                d = g.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "",
                n = k && k.filter || c.filter || "";
            c.zoom = 1;
            if ((1 <= b || "" === b) && "" === g.trim(n.replace(ec, "")) && c.removeAttribute)
                if (c.removeAttribute("filter"),
                    "" === b || k && !k.filter) return;
            c.filter = ec.test(n) ? n.replace(ec, d) : n + " " + d
        }
    });
    g.cssHooks.marginRight = fb(w.reliableMarginRight, function (a, b) {
    ...
    g.each({
        ...
        g.cssHooks[a + b] = {
            expand: function (c) {
                var g = 0,
                    k = {};
                for (c = "string" === typeof c ? c.split(" ") : [c]; 4 > g; g++) k[a + Qa[g] + b] = c[g] || c[g - 2] || c[0];
                return k
            }
        };
        Ic.test(a) || (g.cssHooks[a + b].set = ma)
    });
    g.fn.extend({
        css: function (a, b) {
            return Va(this, function (a,
                ...
                if (g.isArray(f)) {
                    b = Ra(a);
                    for (c = f.length; d < c; d++) k[f[d]] = g.css(a, f[d], !1, b);
                    return k
                }
                return void 0 !== b ? g.style(a, f, b) : g.css(a, f)
        ...
        toggle: function (a) {
            return "boolean" === typeof a ? a ? this.show() : this.hide() : this.each(function () {
                hb(this) ? g(this).show() : g(this).hide()
            })
        }
    });
    g.Tween = L;
    ...
    var Za, Hb, Jd = /^(?:toggle|show|hide)$/,
        ...
        Kd = /queueHooks$/,
        tb = [function (a, b, c) {
            var k, d, n, e, r, j, h = this,
                q = {},
                l = a.style,
                A = a.nodeType && hb(a),
                z = g._data(a, "fxshow");
            c.queue || (e = g._queueHooks(a, "fx"), null == e.unqueued && (e.unqueued = 0, r = e.empty.fire, e.empty.fire = function () {
                    e.unqueued || r()
                }), e.unqueued++,
                h.always(function () {
                    h.always(function () {
                        e.unqueued--;
                        g.queue(a, "fx").length || e.empty.fire()
                    })
                }));
            if (1 === a.nodeType && ("height" in b || "width" in b)) c.overflow = [l.overflow, l.overflowX, l.overflowY], d = g.css(a, "display"), j = db(a.nodeName), "none" === d && (d = j), "inline" === d && "none" === g.css(a, "float") && (!w.inlineBlockNeedsLayout || "inline" === j ? l.display = "inline-block" : l.zoom = 1);
            c.overflow && (l.overflow = "hidden", w.shrinkWrapBlocks() || h.always(function () {
            ...
            for (k in b)
                if (d = b[k], Jd.exec(d)) {
                    ...
                    q[k] = z && z[k] || g.style(a, k)
                } if (!g.isEmptyObject(q))
                for (k in z ? "hidden" in z && (A = z.hidden) : z = g._data(a, "fxshow", {}), n && (z.hidden = !A), A ? g(a).show() : h.done(function () {
                        g(a).hide()
                    }), h.done(function () {
                        var b;
                        g._removeData(a, "fxshow");
                        for (b in q) g.style(a, b, q[b])
                    }), q) b = wa(A ? z[k] : 0, k, h), k in z || (z[k] = b.start, A && (b.end = b.start, b.start = "width" === k || "height" ===
                    k ? 1 : 0))
        }],
        ib = {
            "*": [function (a, b) {
                var c = this.createTween(a, b),
                    k = c.cur(),
                    d = Kc.exec(b),
                    n = d && d[3] || (g.cssNumber[a] ? "" : "px"),
                    e = (g.cssNumber[a] || "px" !== n && +k) && Kc.exec(g.css(c.elem, a)),
                    r = 1,
                    j = 20;
                if (e && e[3] !== n) {
                    n = n || e[3];
                    d = d || [];
                    e = +k || 1;
                    do r = r || ".5", e /= r, g.style(c.elem, a, e + n); while (r !== (r = c.cur() / k) && 1 !== r && --j)
                }
                d && (e = c.start = +e || +k || 0, c.unit = n, c.end = d[1] ? e + (d[1] + 1) * d[2] : +d[2]);
                return c
            }]
        };
    g.Animation = g.extend(jb, {
    ...
    g.speed = function (a, b, c) {
        var k = a && "object" === typeof a ? g.extend({}, a) : {
            complete: c || !c && b || g.isFunction(a) && a,
            duration: a,
            easing: c && b || b && !g.isFunction(b) && b
        };
        k.duration = g.fx.off ? 0 : "number" === typeof k.duration ? k.duration : k.duration in g.fx.speeds ? g.fx.speeds[k.duration] : g.fx.speeds._default;
        if (null == k.queue || !0 === k.queue) k.queue = "fx";
        k.old = k.complete;
        k.complete = function () {
            g.isFunction(k.old) && k.old.call(this);
    ...
    g.fn.extend({
        ...
        animate: function (a, b, c, k) {
            var d = g.isEmptyObject(a),
                n = g.speed(b, c, k);
            b = function () {
                var b = jb(this, g.extend({}, a), n);
                (d || g._data(this, "finish")) && b.stop(!0)
            };
            b.finish = b;
    ...
    g.each(["toggle", "show", "hide"], function (a, b) {
        var c = g.fn[b];
        g.fn[b] = function (a, f, k) {
            return null == a || "boolean" === typeof a ? c.apply(this, arguments) : this.animate(O(b, !0), a, f, k)
        }
    });
    g.each({
        slideDown: O("show"),
    ...
    g.fx.tick = function () {
        var a, b = g.timers,
            c = 0;
        for (Za = g.now(); c < b.length; c++) a = b[c], !a() && b[c] === a && b.splice(c--, 1);
        b.length || g.fx.stop();
        Za = void 0
    };
    ...
    g.fx.interval = 13;
    g.fx.start = function () {
        Hb || (Hb = setInterval(g.fx.tick, g.fx.interval))
    };
    g.fx.stop = function () {
        clearInterval(Hb);
        Hb = null
        ...
        val: function (a) {
            ...
            if (arguments.length) return k =
                g.isFunction(a), this.each(function (c) {
                    if (1 === this.nodeType && (c = k ? a.call(this, c, g(this).val()) : a, null == c ? c = "" : "number" === typeof c ? c += "" : g.isArray(c) && (c = g.map(c, function (a) {
                            return null == a ? "" : a + ""
                        })), b = g.valHooks[this.type] || g.valHooks[this.nodeName.toLowerCase()], !b || !("set" in b) || void 0 === b.set(this, c, "value"))) this.value = c
                });
            if (d) {
                if ((b = g.valHooks[d.type] || g.valHooks[d.nodeName.toLowerCase()]) && "get" in b && void 0 !== (c = b.get(d, "value"))) return c;
                c = d.value;
            ...
            select: {
                get: function (a) {
                    for (var b, c = a.options, k = a.selectedIndex, d = (a = "select-one" === a.type || 0 > k) ? null : [], n = a ? k + 1 : c.length, e = 0 > k ? n : a ? k : 0; e < n; e++)
                        if (b = c[e], (b.selected || e === k) && (w.optDisabled ? !b.disabled : null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !g.nodeName(b.parentNode, "optgroup"))) {
                            b = g(b).val();
                            if (a) return b;
                            d.push(b)
                        } return d
                ...
                set: function (a, b) {
                    for (var c, k, d = a.options,
                            n = g.makeArray(b), e = d.length; e--;)
                        if (k = d[e], 0 <= g.inArray(g.valHooks.option.get(k), n)) try {
                            k.selected = c = !0
                        } catch (r) {
                            k.scrollHeight
                        } else k.selected = !1;
    ...
    g.each(["radio", "checkbox"], function () {
        ...
        w.checkOn || (g.valHooks[this].get = function (a) {
            return null === a.getAttribute("value") ? "on" : a.value
        })
    });
    var cb, Lc, Na = g.expr.attrHandle,
        hc = /^(?:checked|selected)$/i,
        Wa = w.getSetAttribute,
        Jb = w.input;
    g.fn.extend({
        attr: function (a, b) {
            return Va(this, g.attr, a, b, 1 < arguments.length)
        },
    ...
    g.extend({
        attr: function (a, b, c) {
            ...
            if (a && !(3 === n || 8 === n || 2 === n)) {
                if (typeof a.getAttribute === la) return g.prop(a, b, c);
                if (1 !== n || !g.isXMLDoc(a)) b = b.toLowerCase(), k = g.attrHooks[b] || (g.expr.match.bool.test(b) ? Lc : cb);
                if (void 0 !== c)
        ...
        removeAttr: function (a, b) {
            var c, k, d = 0,
                n = b && b.match(xa);
            if (n && 1 === a.nodeType)
                for (; c = n[d++];) k = g.propFix[c] || c, g.expr.match.bool.test(c) ? Jb && Wa || !hc.test(c) ? a[k] = !1 : a[g.camelCase("default-" + c)] = a[k] = !1 : g.attr(a, c, ""), a.removeAttribute(Wa ? c : k)
        },
        attrHooks: {
            type: {
                set: function (a, b) {
                    if (!w.radioValue && "radio" === b && g.nodeName(a, "input")) {
                        var c = a.value;
    ...
    Lc = {
        set: function (a, b, c) {
            !1 === b ? g.removeAttr(a, c) : Jb && Wa || !hc.test(c) ? a.setAttribute(!Wa && g.propFix[c] || c, c) : a[g.camelCase("default-" + c)] = a[c] = !0;
            return c
        }
    };
    g.each(g.expr.match.bool.source.match(/\w+/g), function (a, b) {
        var c = Na[b] || g.find.attr;
        Na[b] = Jb && Wa || !hc.test(b) ? function (a, b, f) {
            var k, g;
            f || (g = Na[b], Na[b] = k, k = null != c(a, b, f) ? b.toLowerCase() : null, Na[b] = g);
            return k
        } : function (a, b, f) {
            if (!f) return a[g.camelCase("default-" + b)] ? b.toLowerCase() : null
        }
    });
    if (!Jb || !Wa) g.attrHooks.value = {
        set: function (a, b, c) {
            if (g.nodeName(a,
    ...
    Wa || (cb = {
        ...
        g.attrHooks[b] = {
            set: function (a, f) {
                if ("" === f) return a.setAttribute(b, "auto"), f
            }
        }
    }));
    w.style || (g.attrHooks.style = {
        get: function (a) {
    ...
    g.fn.extend({
        prop: function (a, b) {
            return Va(this, g.prop, a, b, 1 < arguments.length)
        },
    ...
    g.extend({
        ...
        prop: function (a, b, c) {
            ...
            n = a.nodeType;
            if (a && !(3 === n || 8 === n || 2 === n)) {
                if (n = 1 !== n || !g.isXMLDoc(a)) b = g.propFix[b] || b, d = g.propHooks[b];
    ...
    w.optSelected || (g.propHooks.selected = {
        get: function (a) {
    ...
    w.enctype || (g.propFix.enctype = "encoding");
    var ic = /[\t\r\n\f]/g;
    g.fn.extend({
        addClass: function (a) {
            var b,
        ...
        toggleClass: function (a, b) {
            ...
            return "boolean" === typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : g.isFunction(a) ? this.each(function (c) {
                ...
                this.each(function () {
                    if ("string" === c)
                        for (var b, k = 0, d = g(this), n = a.match(xa) || []; b = n[k++];) d.hasClass(b) ? d.removeClass(b) : d.addClass(b);
                    else if (c === la || "boolean" === c) this.className && g._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : g._data(this, "__className__") || ""
                })
        },
        hasClass: function (a) {
            a = " " + a + " ";
    ...
    g.parseJSON = function (b) {
        ...
        var c, k = null,
            d = g.trim(b + "");
        return d && !g.trim(d.replace(Od, function (a, b, f, g) {
            c && b && (k = 0);
            if (0 === k) return a;
            c = f || b;
            k += !g - !f;
            return ""
        })) ? Function("return " + d)() : g.error("Invalid JSON: " + b)
    };
    g.parseXML = function (b) {
        var c, k;
        ...
        try {
            ...
            c.getElementsByTagName("parsererror").length) && g.error("Invalid XML: " + b);
        return c
    };
    var Xa, Oa, Pd = /#.*$/,
        Mc = /([?&])_=[^&]*/,
    ...
    g.extend({
        ...
        ajaxSetup: function (a, b) {
            return b ? ya(ya(a,
                g.ajaxSettings), b) : ya(g.ajaxSettings, a)
        },
        ajaxPrefilter: kb(Oc),
        ajaxTransport: kb(Nb),
        ajax: function (a, b) {
            function c(a, b, f, k) {
                ...
                if (2 !== ea) {
                    ...
                    if (f) {
                        ...
                        F ? (F !== P[0] && P.unshift(F), p = f[F]) : p = void 0
                    }
                    a: {
                        f = q;N = p;ia = s;F = k;
                        var w, Y, u, v = {},
                            E = f.dataTypes.slice();
                        if (E[1])
                            for (Y in f.converters) v[Y.toLowerCase()] = f.converters[Y];
                        for (B = E.shift(); B;)
                            if (f.responseFields[B] && (ia[f.responseFields[B]] = N), !u && (F && f.dataFilter) && (N = f.dataFilter(N, f.dataType)), u = B, B = E.shift())
                                if ("*" === B) B = u;
                                else if ("*" !== u && u !== B) {
                            Y = v[u + " " + B] || v["* " + B];
                            if (!Y)
                                ...
                                if (Y && f["throws"]) N = Y(N);
                                    ...
                                    p = {
                                        state: "parsererror",
                                        error: Y ? I : "No conversion from " + u + " to " + B
                                    };
                                    break a
                                }
                        }
                    ...
                    if (k) q.ifModified && ((K = s.getResponseHeader("Last-Modified")) && (g.lastModified[n] = K), (K = s.getResponseHeader("etag")) && (g.etag[n] = K)), 204 === a || "HEAD" === q.type ? K = "nocontent" : 304 === a ? K = "notmodified" : (K = p.state, d = p.data, l = p.error, k = !l);
                    else if (l = K, a || !K) K = "error", 0 > a && (a = 0);
                    s.status = a;
                    s.statusText = (b || K) +
                        "";
                    k ? T.resolveWith(A, [d, K, s]) : T.rejectWith(A, [s, K, l]);
                    s.statusCode(m);
                    m = void 0;
                    j && z.trigger(k ? "ajaxSuccess" : "ajaxError", [s, q, k ? d : l]);
                    t.fireWith(A, [s, K]);
                    j && (z.trigger("ajaxComplete", [s, q]), --g.active || g.event.trigger("ajaxStop"))
                }
            }
            "object" === typeof a && (b = a, a = void 0);
            b = b || {};
            var k, d, n, e, r, j, h, l, q = g.ajaxSetup({}, b),
                A = q.context || q,
                z = q.context && (A.nodeType || A.jquery) ? g(A) : g.event,
                T = g.Deferred(),
            ...
            s.success = s.done;
            s.error = s.fail;
            q.url = ((a || q.url || Oa) + "").replace(Pd, "").replace(Sd, Xa[1] + "//");
            q.type = b.method || b.type || q.method || q.type;
            q.dataTypes = g.trim(q.dataType || "*").toLowerCase().match(xa) || [""];
            null == q.crossDomain && (k = Nc.exec(q.url.toLowerCase()), q.crossDomain = !(!k || !(k[1] !== Xa[1] || k[2] !== Xa[2] || (k[3] || ("http:" === k[1] ? "80" : "443")) !== (Xa[3] || ("http:" === Xa[1] ? "80" : "443")))));
            q.data && (q.processData && "string" !== typeof q.data) && (q.data = g.param(q.data, q.traditional));
            ub(Oc, q, b, s);
            if (2 ===
                ea) return s;
            (j = q.global) && 0 === g.active++ && g.event.trigger("ajaxStart");
            q.type = q.type.toUpperCase();
            q.hasContent = !Rd.test(q.type);
            n = q.url;
            q.hasContent || (q.data && (n = q.url += (kc.test(n) ? "&" : "?") + q.data, delete q.data), !1 === q.cache && (q.url = Mc.test(n) ? n.replace(Mc, "$1_=" + jc++) : n + (kc.test(n) ? "&" : "?") + "_=" + jc++));
            q.ifModified && (g.lastModified[n] && s.setRequestHeader("If-Modified-Since", g.lastModified[n]), g.etag[n] && s.setRequestHeader("If-None-Match", g.etag[n]));
            (q.data && q.hasContent && !1 !== q.contentType || b.contentType) &&
            s.setRequestHeader("Content-Type", q.contentType);
            s.setRequestHeader("Accept", q.dataTypes[0] && q.accepts[q.dataTypes[0]] ? q.accepts[q.dataTypes[0]] + ("*" !== q.dataTypes[0] ? ", " + Pc + "; q=0.01" : "") : q.accepts["*"]);
            for (d in q.headers) s.setRequestHeader(d, q.headers[d]);
            if (q.beforeSend && (!1 === q.beforeSend.call(A, s, q) || 2 === ea)) return s.abort();
            ia = "abort";
            for (d in {
                    success: 1,
                    error: 1,
    ...
    g.each(["get", "post"], function (a, b) {
        g[b] = function (a, c, f, k) {
            g.isFunction(c) && (k = k || f, f = c, c = void 0);
            return g.ajax({
                url: a,
                type: b,
                dataType: k,
    ...
    g.expr.filters.hidden = function (a) {
        return 0 >= a.offsetWidth && 0 >= a.offsetHeight || !w.reliableHiddenOffsets() && "none" === (a.style &&
            a.style.display || g.css(a, "display"))
    };
    ...
    g.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var a = this.type;
                return this.name && !g(this).is(":disabled") && Vd.test(this.nodeName) && !Ud.test(a) && (this.checked || !Mb.test(a))
            }).map(function (a, b) {
                var c = g(this).val();
    ...
    g.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function () {
        var b;
                ...
                send: function (c, k) {
                    ...
                    b = function (c, d) {
                        ...
                        if (b && (d || 4 === n.readyState))
                            if (delete Kb[e], b = void 0, n.onreadystatechange = g.noop, d) 4 !== n.readyState && n.abort();
                            else {
                                j = {};
                                r = n.status;
                                "string" === typeof n.responseText && (j.text = n.responseText);
                                try {
                                    q = n.statusText
                                } catch (h) {
                                    q = ""
                                }!r && a.isLocal && !a.crossDomain ? r = j.text ? 200 : 404 : 1223 === r && (r = 204)
                            } j && k(r, q, j, n.getAllResponseHeaders())
                    };
    ...
    g.ajaxTransport("script", function (a) {
        if (a.crossDomain) {
            var b,
                c = y.head || g("head")[0] || y.documentElement;
            return {
                send: function (k, g) {
    ...
    g.ajaxPrefilter("json jsonp", function (b, c, k) {
        ...
        if (r || "jsonp" === b.dataTypes[0]) return d = b.jsonpCallback = g.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, r ? b[r] = b[r].replace(lc, "$1" + d) : !1 !== b.jsonp && (b.url += (kc.test(b.url) ? "&" : "?") + b.jsonp + "=" +
            d), b.converters["script json"] = function () {
            e || g.error(d + " was not called");
            return e[0]
    ...
    g.fn.load = function (a, b, c) {
        ...
        g.isFunction(b) ? (c = b, b = void 0) : b && "object" === typeof b && (n = "POST");
        0 < e.length && g.ajax({
            url: a,
            type: n,
            dataType: "html",
            ...
            d = arguments;
            e.html(k ? g("<div>").append(g.parseHTML(a)).find(k) : a)
        }).complete(c && function (a, b) {
            e.each(c, d || [a.responseText, b, a])
        });
        return this
    };
    g.expr.filters.animated =
        function (a) {
    ...
    g.offset = {
        setOffset: function (a, b, c) {
            ...
            d = g.css(a, "top");
            k = g.css(a, "left");
            ("absolute" === e || "fixed" === e) && -1 < g.inArray("auto", [d, k]) ? (k = r.position(), d = k.top, k = k.left) : (d = parseFloat(d) || 0, k = parseFloat(k) || 0);
            g.isFunction(b) && (b = b.call(a, c, n));
            null != b.top && (q.top = b.top - n.top + d);
            null != b.left && (q.left =
                b.left - n.left + k);
            "using" in b ? b.using.call(a, q) : r.css(q)
        }
    };
    g.fn.extend({
        offset: function (a) {
        ...
        position: function () {
            if (this[0]) {
                var a,
                    ...
                    k = this[0];
                "fixed" === g.css(k, "position") ? b = k.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), g.nodeName(a[0], "html") || (c = a.offset()), c.top += g.css(a[0], "borderTopWidth", !0), c.left += g.css(a[0], "borderLeftWidth", !0));
                return {
                    top: b.top - c.top - g.css(k, "marginTop", !0),
                    left: b.left - c.left - g.css(k, "marginLeft", !0)
                }
            }
        },
        offsetParent: function () {
            return this.map(function () {
                for (var a = this.offsetParent || Tc; a && !g.nodeName(a, "html") && "static" === g.css(a, "position");) a = a.offsetParent;
                return a ||
                    Tc
            })
        }
    ...
    g.each({
        ...
        var c = /Y/.test(b);
        g.fn[a] = function (k) {
            return Va(this, function (a, k, f) {
                var d = V(a);
                if (void 0 === f) return d ? b in d ? d[b] : d.document.documentElement[k] : a[k];
                d ? d.scrollTo(!c ? f : g(d).scrollLeft(), c ? f : g(d).scrollTop()) : a[k] = f
            }, a, k, arguments.length, null)
        }
    });
    g.each(["top", "left"], function (a, b) {
        g.cssHooks[b] = fb(w.pixelPosition, function (a, c) {
            if (c) return c = Sa(a, b), sb.test(c) ? g(a).position()[b] + "px" : c
        })
    });
    g.each({
            Height: "height",
            ...
            g.each({
                ...
                g.fn[k] = function (k, d) {
                    ...
                    return Va(this, function (b, c, k) {
                        return g.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType ? (c = b.documentElement, Math.max(b.body["scroll" + a], c["scroll" + a], b.body["offset" + a], c["offset" + a], c["client" + a])) : void 0 === k ? g.css(b, c, e) : g.style(b, c, k, e)
                    }, b, n ? k : void 0, n, null)
                }
            })
        });
    ...
    var Xd = a.jQuery,
        Yd = a.$;
    g.noConflict = function (b) {
        a.$ === g && (a.$ = Yd);
        b && a.jQuery === g && (a.jQuery = Xd);
        return g
    };
    typeof m === la && (a.jQuery = a.$ = g);
    return g
});
(function (a) {
    function m(a) {
...
(function (a, m) {
    ...
    a._getFileData = function (b, c, d) {
        ...
        var s = !l && a.$supportsIECrossDomainScripting(),
            u = null;
        if (t || j || !l && !m || !c &&
            s) u = a._getRawDataFromServer("_", b, c, c, j, !0);
        else {
    ...
    a._doAjax = function (b, c, d) {
        b = b.toString();
        if (null != d) return a._saveFile(b, d);
        c && (b += "?POST?" + c);
    ...
    a._saveFile = function (b, c, d, e) {
        ...
        c = (JU ? JU : J.util).Base64.getBase64("string" == typeof c ? c.getBytes("UTF-8") : c).toString();
        e || (e = "base64");
        var j = a._serverUrl;
        j && 0 <= j.indexOf("your.server") && (j = "");
...
(function (a) {
    ...
    a._jsSetPrototype = function (b) {
        ...
        b._createCanvas2d = function () {
            ...
            try {
                b[0].removeChild(this._canvas), this._canvas.frontLayer && b[0].removeChild(this._canvas.frontLayer), this._canvas.rearLayer && b[0].removeChild(this._canvas.rearLayer), this._canvas.contentLayer && b[0].removeChild(this._canvas.contentLayer), a._jsUnsetMouse(this._mouseInterface)
            } catch (c) {}
    ...
    a._loadImage = function (b, e, j, h, l, t) {
        var m = "echo_" + e + j + (h ? "_" + h.length : ""),
            s = a._getHiddenCanvas(b.vwr.html5Applet, m, 0, 0, !1, !0);
        if (null == s) {
            if (null == t) {
                t = new Image;
                if (null == h) return t.onload = function () {
                    a._loadImage(b, e, j, null, l, t)
                }, t.src = j, null;
                System.out.println("Jsmol.js Jmol._loadImage using data URI for " +
                    m);
            ...
            var u = t.width,
                U = t.height;
            "webgl" == e && (u /= 2, U /= 2);
            s = a._getHiddenCanvas(b.vwr.html5Applet, m, u, U, !0, !1);
            s.imageWidth = u;
            s.imageHeight = U;
            s.id = m;
            s.image = t;
            a._setCanvasImage(s, u, U)
        } else System.out.println("Jsmol.js Jmol._loadImage reading cached image for " + m);
        return null == h ? l(s, j) : s
    };
    a._canvasCache = {};
    a._getHiddenCanvas = function (b, e, j, h, l, t) {
        e = b._id + "_" + e;
        b = a._canvasCache[e];
        if (t) return b;
        if (l || !b || b.width !=
    ...
    a._setCanvasImage = function (a, b, e) {
        a.buf32 = null;
        a.width = b;
        a.height = e;
...
(function (a, m) {
    ...
    h._getAtomCorrelation = function (a) {
        this._loadMolData(a, "atommap = compare({1.1} {2.1} 'MAP' 'H'); zap 2.1", !0);
        a = this._evaluate("atommap");
        for (var j = this._evaluate("{*}.count"), h = [], l = [], m = 0; m < a.length; m++) {
            var b = a[m];
            h[b[0] + 1] = b[1] - j + 1;
            l[b[1] - j + 1] = b[0] + 1
        }
    ...
    h._scriptWaitOutput = function (a) {
        var j = "";
        try {
            a && (j += this._applet.scriptWaitOutput(a))
        } catch (h) {}
        return j
    };
    h._scriptWaitAsArray = function (e) {
        var j = "";
        try {
            if (this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"), e && (j += this._applet.scriptWait(e), j = a._evalJSON(j, "jmolStatus"), "object" ==
                    typeof j)) return j
        } catch (h) {}
        return [
            [j]
    ...
    h._getPropertyAsArray = function (e, j) {
        return a._evalJSON(this._getPropertyAsJSON(e, j), e)
    };
    h._getPropertyAsString = function (a, j) {
        void 0 == j && (j = "");
        return this._applet.getPropertyAsString(a, j) + ""
    };
    h._getPropertyAsJSON = function (a, j) {
        void 0 == j && (j = "");
        try {
            return this._applet.getPropertyAsJSON(a, j) + ""
        } catch (h) {
            return ""
        }
    };
    h._getPropertyAsJavaObject = function (a, j) {
        void 0 == j && (j =
            "");
        return this._applet.getProperty(a, j)
    };
    ...
    h._evaluateDEPRECATED = function (a) {
        ...
        var j = a.replace(/\-*\d+/, "");
        if ("" == j && !isNaN(parseInt(a))) return parseInt(a);
        j = a.replace(/\-*\d*\.\d*/, "");
        return "" == j && !isNaN(parseFloat(a)) ? parseFloat(a) : a
    };
    h._saveOrientation = function (a) {
        return this._savedOrientations[a] = this._getPropertyAsArray("orientationInfo", "info").moveTo
    };
    h._restoreOrientation =
        function (a) {
            a = this._savedOrientations[a];
            return !a || "" == a ? a.replace(/1\.0/, "0") : this._scriptWait(a)
        };
    h._restoreOrientationDelayed = function (a, j) {
        1 > arguments.length && (j = 1);
        var h = this._savedOrientations[a];
        return !h || "" == h ? h.replace(/1\.0/, j) : this._scriptWait(h)
    };
    h._resizeApplet = function (e) {
        function j(e, h) {
            var b = "" + e;
            return 0 == b.length ? h ? "" : a._allowedJmolSize[2] : b.indexOf("%") == b.length - 1 ? b : 1 >= (e = parseFloat(e)) && 0 < e ? 100 * e + "%" : (isNaN(e = Math.floor(e)) ? a._allowedJmolSize[2] : e < a._allowedJmolSize[0] ? a._allowedJmolSize[0] :
                e > a._allowedJmolSize[1] ? a._allowedJmolSize[1] : e) + (h ? h : "")
        }
        var h;
        "object" == typeof e && null != e ? (h = e[0] || e.width, e = e[1] || e.height) : h = e;
        h = [j(h, "px"), j(e, "px")];
        e = a._getElement(this, "appletinfotablediv");
        e.style.width = h[0];
        e.style.height = h[1];
        this._containerWidth = h[0];
        this._containerHeight = h[1];
    ...
    h._searchDatabase = function (e, h, l) {
        if (this._2dapplet && this._2dapplet._isEmbedded && !a.$(this, "appletdiv:visible")[0]) return this._2dapplet._searchDatabase(e,
            h, l);
        this._showInfo(!1);
    ...
    h.__loadModel = function (e, h, l) {
        null != e && (null != this._viewSet && (h || (h = ""), h += ";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};"), !h && this._noscript ? this._applet.loadInlineString(e, "", !1) : this._loadMolData(e,
            h, !1), null != this._viewSet && a.View.updateView(this, {
            chemID: l,
            data: e
        }))
    };
    ...
    h._updateAtomPick = function (a) {
        this._script(0 == a.length ? "select none" : "select on visible and (@" +
            a.join(",@") + ")")
    };
    ...
    h._cover = function (e) {
        e || !this._deferApplet ? this._displayCoverImage(e) : (e = this._coverScript ? this._coverScript : "", this._coverScript = "", this._deferUncover && (e += ";refresh;javascript " + this._id + "._displayCoverImage(false)"), this._script(e, !0), this._deferUncover && "activate 3D model" == this._coverTitle &&
            (a._getElement(this, "coverimage").title = "3D model is loading..."), this._isJava || this._newCanvas(!1), this._defaultModel && a._search(this, this._defaultModel), this._showInfo(!1), this._deferUncover || this._displayCoverImage(!1), this._isJava && a.$html(a.$(this, "appletdiv"), this._javaCode), this._init && this._init())
    };
    h._displayCoverImage = function (e) {
        this._coverImage && this._isCovered != e && (this._isCovered = e, a._getElement(this, "coverdiv").style.display = e ? "block" : "none")
    };
        ...
        if ("object" != u || null == u || !h.length) alert("invalid arrayOfRadioButtons");
            ...
            for (var c = "<span id='" + (t ? t : j) + "'>", d = 0; d < b; ++d) {
                ...
                var q = h[d],
                    u = typeof q,
                    K = null,
                    c = "object" == u ? c + (K = m._radio(l, q[0], q[1], q[2], e, j, 3 < q.length ? q[3] : (t ? t : j) + "_" + d, 4 < q.length ? q[4] : 0,
                        s)) : c + (K = m._radio(l, q, null, null, e, j, (t ? t : j) + "_" + d, s));
                if (null == K) return ""
            }
            c += "</span>";
            a._debugAlert && alert(c);
    ...
    window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !0, window["j2s.object.native"] = !0, Clazz = {
        ...
        a.defineMethod = function (c, d, h, j) {
            ...
            if (!m.stacks || m.claxxReference !== c) {
                                ...
                                if (r || j[l] === d) {
                                    ...
                                    for (F in m)
                                        if (92 == F.charCodeAt(0)) {
                                            ...
                                            u.length == z.length && s.push(u);
                                            t = !1
                                        } else if (t && "funParams" == F && m.funParams) {
                                        F = m.funParams;
                                        u = F.substring(1).split("\\");
                                        u.length == z.length && (s[0] = u);
                                        break
                                    }
                                    F = void 0;
                                    if (!(F = 0 == s.length)) {
                                        F = void 0;
                                        for (var F = [], P = s.length, u = 0; u < P; u++) {
                                            for (var x = [], za = !0, C = s[u].length, B = 0; B < C; B++)
                                                if (x[B] = a.getInheritedLevel(z[B], s[u][B]), 0 > x[B]) {
                                                    za = !1;
                                                    break
                ...
                m = l[d] = m;
                d = [];
                for (l = 0; l < s.length; l++) d[l] = s[l];
                m.stacks = d
            }
            s = m.stacks;
            0 > rb(s, c) && s.push(c);
            q && (q.claxxOwner === c ? (m[q.funParams] = q, q.claxxOwner = null, q.funParams = null) : q.claxxOwner || (m["\\unknown"] = q));
            h.exClazz = c;
            m[j] = h;
            return m
        };
        ...
        (function (a, b) {
            ...
            b.loadPackageClasspath =
                function (a, c, d, e, g, h) {
                    ...
                    h || (h = 0);
                    var j = d && D["@" + a];
                    if (0 == g && (d && !D["@java"] && 0 != a.indexOf("java") && null != window["java.registered"] && !D["@java"]) && (b.loadPackage("java", e ? function () {
                    ...
                    if (a instanceof Array)
                        ...
                        switch (a) {
                            ...
                            case "java":
                                c &&
                                    (g = "@net.sf.j2s.ajax", D[g] || (D[g] = c), g = "@net.sf.j2s", D[g] || (D[g] = c));
                                break;
                            case "swt":
                                a = "org.eclipse.swt";
                                break;
                        ...
                        c && (D["@" + a] = c);
                        d && !j && !window[a + ".registered"] ? (K++, "java" == a && (a = "core"), b.loadClass(a + ".package", function () {
                            0 == --K && ca()
                        }, !0, !0, 1)) : e && e()
                    }
                };
            ...
            b.loadClass = function (c, g, h, j, l) {
                l || (l = 0);
                null == j && (j = !1);
                if ("boolean" == typeof g) return a.evalType(c);
                null != window["java.registered"] && !D["@java"] && b.loadPackage("java");
                b.keepOnLoading = !0;
                if (!h && (K && c.lastIndexOf(".package") != c.length - 8 || 0 != c.indexOf("java.") && !isClassDefined(da))) La.push([c, g]), System.out.println("loadclass-queuing" + c + da + " " + isClassDefined(da));
                else if ((l = isClassDefined(c)) || O["@" + c]) {
                    if (l && g && (h = H(c), !h || h.status >= x.STATUS_LOAD_COMPLETE)) j ? window.setTimeout(g, 25) : g()
                } else {
                    var m =
                        b.getClasspathFor(c);
                    l = e[m];
                    if (!l)
                        ...
                        if (!c) {
                            ...
                            h && (g = null);
                            Ja(d, l, !0);
                            V(l, l.path, l.requiredBy, !1, g ? function () {
                                ha = s;
                                g()
                            } : null)
                        }
            ...
            b.registerPackages = function (c, d) {
                for (var e =
                        b.getClasspathFor(c + ".*", !0), g = 0; g < d.length; g++) window.Clazz && a.declarePackage(c + "." + d[g]), b.loadPackageClasspath(c + "." + d[g], e)
            };
            b.getClasspathFor = function (c, d, e) {
                ...
                if (!g || d || e) {
                    var h, j;
                    if (g) {
                        if (c = c.replace(/\./g, "/"), 0 <= (j = g.lastIndexOf(c)) || 0 <= (j = c.lastIndexOf("/")) && 0 <= (j = g.lastIndexOf(c.substring(0, j)))) h = g.substring(0, j)
                    } else {
                    ...
                    g = (h.lastIndexOf("/") == h.length - 1 ? h : h + "/") + (d ? "" : c.lastIndexOf("/*") == c.length - 2 ? c.substring(0, j + 1) : c + (!e ? ".js" : "." != e.charAt(0) ? "." + e : e))
                }
                return g
            };
            b.ignore = function () {
            ...
            var V = function (c,
                    ...
                    M = !0;
                    sa = !1;
                    b._checkLoad && System.out.println("\t" + d + (g ? "\n -- required by " + g : "") + "  ajax=" + M + " async=" + sa);
                    g = d;
                ...
                ua = function (c, d, e) {
                    a.getStackTrace();
                    return function () {
                        g && this.timeoutHandle && (window.clearTimeout(this.timeoutHandle), this.timeoutHandle = null);
                        0 < h && h--;
                ...
                na = function (a, c) {
                    var d = ma,
                        e = d.length;
                    d.push(a);
                    for (var g = e; 0 <= --g && !(d[g] === a && d[g].status >= x.STATUS_DECLARED););
                    if (0 <= g) {
                        if (b._checkLoad) {
                            var h;
                    ...
                    for (h = 0; 2 > h; h++) {
                        k = j[h];
                        for (g = k.length; 0 <= --g;)
                            if (k[g].status == x.STATUS_DECLARED && na(k[g], c)) return !0
                    }
                    d.length = e;
                    return !1
                };
            ...
            var va = function (a, b, c, d, e) {
                ...
                if (c.parents && c.parents.length && c.parents[0] && c.parents[0].name) {
                    ...
                    for (var g = 0; g < c.parents.length; g++) a = va(a, b, c.parents[g], d + "\t", e + 1);
                    a += "\n"
                }
                return a
            };
                ...
                if (!a.name ||
                    ...
                    if (a.musts.length && a.declaration)
                        for (var d = a.musts.length, e = d; 0 <= --e;) {
                            var g = a.musts[e];
                            g.requiredBy = a;
                            if (g.status < x.STATUS_DECLARED && isClassDefined(g.name)) {
                                var h = [];
                                g.status = x.STATUS_LOAD_COMPLETE;
                                Da(g);
                                if (g.declaration && g.declaration.clazzList) {
                                    for (var j = 0, k = g.declaration.clazzList, l = k.length; j < l; j++) {
                                        var m = H(k[j]);
                                        m && (m.status != x.STATUS_LOAD_COMPLETE && m !== g) && (m.status = g.status, m.declaration = null, Da(m), m.onLoaded && h.push(m))
                                    }
                                    g.declaration = null
                                }
                                g.onLoaded &&
                            ...
                            } else g.status == x.STATUS_CONTENT_LOADED && updateNode(g), g.status < x.STATUS_DECLARED && (c = !1);
            ...
            var Ta = function (a, b) {
                ...
                $a = function (a, b) {
                    for (var c = d.random, e = b.length; 0 <= --e;) {
                        var g = b[e];
                        if (g.name == a || g.random != c && (g.random = c, g = Ea(a, g))) return g
                    }
                    return null
                },
                Aa = function (a, b) {
                ...
                oa = function (a, b) {
                    if (a)
                        for (var c = d.random, e = 0; e < a.length; e++) {
                            var g = a[e];
                            if (Aa(g, b) || g.random != c && (g.random = c, g = Ca(g, b))) return g
                        }
                    return null
                },
                R = function (a, c, e, g) {
                    if (c instanceof Array) {
                        C(c);
                        for (var h = 0; h < c.length; h++) R(a, c[h], e, g, c)
                    } else {
                        ...
                        ja(h, a, !0);
                        5 == arguments.length && g && (g.status = h.status, g.clazzList = arguments[4]);
                        if (h.declaration = g) h.status = x.STATUS_CONTENT_LOADED;
                        ja(h, e, !1)
                    }
                },
                ja = function (a, b, c) {
                    if (b && b.length) {
                        ...
                        for (var d = 0; d < b.length; d++) {
                            ...
                            if (e && !isClassDefined(e) && !O["@" + e]) {
                                var g = H(e);
                                g || (g = new x, g.name = e, g.status = x.STATUS_KNOWN);
                                g.requiredBy =
                                    a;
                                Ja(a, g, c)
                            }
