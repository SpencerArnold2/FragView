...
THREE.Sprite = function (a) {
    ...
    this.mergeIntoThis3D = a.mergeIntoThis3D !== void 0 ? a.mergeIntoThis3D : !this.useScreenCoordinates;
...
THREE.WebGLRenderer = function (a) {
            ...
            if (s) {
                ...
                for (j = s.length; k < j; k++) {
                    ...
                    if (i.needsUpdate && (i.boundTo === void 0 || i.boundTo === "vertices")) {
                        ...
                        f = 0;
                        if (i.size === 1)
                            for (d = 0; d < e; d++) i.array[d] = i.value[d];
                        else if (i.size === 2)
                            for (d = 0; d < e; d++) {
                                h = i.value[d];
                                i.array[f] = h.x;
    ...
    var a = a || {},
        H = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"),
    ...
    this.render = function (a, b, c, d) {
        ...
        for (e = n.length; d < e; d++) {
            ...
            if (j.visible && (!(j instanceof THREE.Mesh || j instanceof THREE.ParticleSystem) || !j.frustumCulled || Yb.contains(j))) {
                ...
                if (this.sortObjects)
                    if (j.renderDepth) f.z = j.renderDepth;
                    else {
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsRemoved.length;) {
            ...
            if (mc instanceof THREE.Mesh || mc instanceof THREE.Line)
                for (var Fb = a.__webglObjects, Xb = mc, nc = Fb.length - 1; nc >= 0; nc--) Fb[nc].object === Xb && Fb.splice(nc, 1);
        ...
        for (var Gb = 0, Yb = a.__webglObjects.length; Gb < Yb; Gb++) {
                    ...
                    for (var zc = 0, jc = V.geometryGroupsList.length; zc < jc; zc++) {
                        ...
                        if (V.verticesNeedUpdate || V.morphTargetsNeedUpdate || V.elementsNeedUpdate || V.uvsNeedUpdate || V.normalsNeedUpdate || V.colorsNeedUpdate || V.tangetsNeedUpdate || Nb) {
                            ...
                            if (M.__inittedArrays) {
                                var Vb = d(Hb),
                                    Ac = Hb.vertexColors ? Hb.vertexColors :
                                    false,
                                    Wb = e(Hb),
            ...
            else if (Va instanceof THREE.Line) {
                Ea = c(Va, $b);
                Nb = Ea.attributes && m(Ea);
                    ...
                    if (Hc) {
                        ...
                        for (Mc = Hc.length; xc < Mc; xc++) {
                            ...
                            if (aa.needsUpdate && (aa.boundTo === void 0 || aa.boundTo === "vertices")) {
                                ...
                                Tb = aa.value.length;
                                if (aa.size === 1)
                                    for (wa = 0; wa < Tb; wa++) aa.array[wa] = aa.value[wa];
                                else if (aa.size === 2)
                                    for (wa = 0; wa < Tb; wa++) {
                                        Fa = aa.value[wa];
                                        aa.array[ia] =
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        var p;
        a: {
            m = a.fragmentShader;k = a.vertexShader;
            var i = a.uniforms,
                b = a.attributes,
                c = {
                    map: !!a.map,
            ...
            for (p in b) d.push(p);p = d;u = 0;
            for (b = p.length; u < b; u++) {
                c = p[u];
                s.attributes[c] = g.getAttribLocation(s, c)
            }
            s.id = Na.length;Na.push({
                program: s,
                code: h
            });D.info.memory.programs = Na.length;p = s
        }
        a.program = p;
        ...
        if (a.attributes)
            for (f in a.attributes) p[f] !== void 0 && p[f] >= 0 && g.enableVertexAttribArray(p[f]);
        if (a.morphTargets) {
...
THREE.CubeGeometry = function (a, b, c, d, e, f, h, i) {
    ...
    if (i != void 0)
        for (var y in i) this.sides[y] !== void 0 && (this.sides[y] = i[y]);
...
THREE.PlaneGeometry = function (a, b, c, d) {
    ...
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, h = c + 1, i = d + 1, l = a / c, k = b / d, j = new THREE.Vector3(0, 1, 0), a = 0; a < i; a++)
        for (b = 0; b < h; b++) this.vertices.push(new THREE.Vector3(b * l - e, 0, a * k - f));
    for (a = 0; a < d; a++)
        for (b = 0; b < c; b++) {
