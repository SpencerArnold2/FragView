...
top_srcdir='/var/www/html/ImageMagick-7.0.8-28'
top_builddir='/var/www/html/ImageMagick-7.0.8-28'

MAGICK_CODER_MODULE_PATH='/var/www/html/ImageMagick-7.0.8-28/coders'
MAGICK_CONFIGURE_SRC_PATH='/var/www/html/ImageMagick-7.0.8-28/config'
MAGICK_CONFIGURE_BUILD_PATH='/var/www/html/ImageMagick-7.0.8-28/config'
MAGICK_FILTER_MODULE_PATH='/var/www/html/ImageMagick-7.0.8-28/filters'
DIRSEP=':'
