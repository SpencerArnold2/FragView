...
-->
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{ url_for('static', filename='build/molview-app.min.css')}}" />
		<link type="text/css" rel="stylesheet" href="{{ url_for('static', filename='build/molview-desktop.min.css')}}" media="screen" />
		<?php
			if($touch)
			{
		...
		<!-- JS -->
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-base.min.js') }}"></script>
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-applib.min.js') }}"></script>
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-datasets.min.js') }}"></script>
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-core.min.js') }}"></script>
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-molpad.min.js') }}"></script>
		<script type="text/javascript" src="{{ url_for('static', filename='build/molview-app.min.js') }}"></script>
